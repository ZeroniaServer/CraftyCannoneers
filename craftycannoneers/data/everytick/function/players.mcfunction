...
execute at @s[team=Spectator] at @e[type=marker,tag=seagullSpawner,distance=..20,limit=1,sort=nearest] run particle dust{color:[0.0,1.0,1.0],scale:2.0} ~ ~ ~ 1 1 1 0.1 10 normal @s[distance=..20]
