...
execute as @a[team=] run title @s subtitle ["",{"text":"V0.3.0 ","color":"aqua"},{"text":"Made by ","color":"gray"},{"text":"Zeronia","color":"green"},{"text":"!","color":"gray"}]
execute as @a[team=] run function tutorial:notify
