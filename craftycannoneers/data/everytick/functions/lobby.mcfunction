...
execute if score $gamestate CmdData matches 2 run effect give @a[team=Lobby] jump_boost 1000000 255 true
execute unless score $gamestate CmdData matches 2 run effect clear @a[team=Lobby] jump_boost
