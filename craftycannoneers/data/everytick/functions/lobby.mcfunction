...
execute as @a[team=,tag=!hasMoved,scores={jump=1..}] run tag @s add hasMoved
execute as @a[team=,tag=!hasMoved,scores={walk=30..}] run tag @s add hasMoved
execute as @a[team=,tag=!hasMoved,scores={sprint=50..}] run tag @s add hasMoved
execute as @a[team=,tag=!hasMoved,scores={crouch=30..}] run tag @s add hasMoved

execute as @a[team=!] run scoreboard players reset @s jump
execute as @a[team=!] run scoreboard players reset @s walk
execute as @a[team=!] run scoreboard players reset @s sprint
execute as @a[team=!] run scoreboard players reset @s crouch

execute as @a[team=,tag=hasMoved] run tag @s add LeaveGame
execute as @a[team=,tag=hasMoved] run tellraw @s ["","\n",{"text":"Ahoy ","color":"aqua"},{"selector":"@s","color":"dark_aqua"},{"text":"!","color":"aqua"},"\n",{"text":"Welcome to ","color":"green"},{"text":"Crafty ","bold":true,"color":"dark_purple"},{"text":"Cannoneers","bold":true,"color":"gold"},{"text":"!","color":"green"},"\n",{"text":"Feel free to explore the lobby to learn about some of the game's basic mechanics.","color":"green"},"\n",{"text":"Have fun!","color":"dark_green"}]
execute as @a[team=,tag=hasMoved] run title @s title ["",{"text":"Crafty ","bold":true,"color":"dark_purple"},{"text":"Cannoneers","bold":true,"color":"gold"}]
execute as @a[team=,tag=hasMoved] run title @s subtitle ["",{"text":"V0.3.0 ","color":"aqua"},{"text":"Made by ","color":"gray"},{"text":"Zeronia","color":"green"},{"text":"!","color":"gray"}]
execute as @a[team=,tag=hasMoved] run function tutorial:notify
