execute if entity @s[tag=!lchest,tag=!BlastBarrel] run summon villager ~ ~ ~ {NoAI:1b,Silent:1b,Invulnerable:1b,NoGravity:1b,Age:-10000000,Tags:["newVillager"],PersistenceRequired:1b,Passengers:[{id:"minecraft:marker",Tags:["newVillager"]}]}
...
execute if entity @s[tag=BlastBarrel] run summon villager ~ ~ ~ {NoAI:1b,Silent:1b,NoGravity:1b,Age:-10000000,Tags:["newVillager"],PersistenceRequired:1b,ActiveEffects:[{Id:11,Amplifier:100b,Duration:1000000,ShowParticles:0b}],Passengers:[{id:"minecraft:marker",Tags:["newVillager"]}]}
