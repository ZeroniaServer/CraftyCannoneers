...
execute if entity @s[tag=bcannon] run ride @e[type=interaction,tag=BoatCannonBlocker,limit=1,sort=nearest] mount @e[type=villager,tag=newVillager,limit=1]
execute if entity @s[tag=bcannon] run ride @e[type=husk,tag=BoatCannonDisplay,limit=1,sort=nearest] mount @e[type=villager,tag=newVillager,limit=1]
