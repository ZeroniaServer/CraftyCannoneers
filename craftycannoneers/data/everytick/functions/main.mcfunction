...
#Arena water
execute if score $gamestate CmdData matches 2.. as @a[team=!Lobby,team=!Spectator,team=!Developer,scores={drowning=1}] at @s run playsound minecraft:entity.player.hurt_drown master @a ~ ~ ~ 1 1
execute if score $gamestate CmdData matches 2.. as @a[team=!Lobby,team=!Spectator,team=!Developer,scores={drowning=4}] at @s run playsound minecraft:entity.player.hurt_drown master @a ~ ~ ~ 1 1.2
execute if score $gamestate CmdData matches 2.. as @a[team=!Lobby,team=!Spectator,team=!Developer,scores={drowning=1}] at @s run title @s title {"text":"OUT OF BOUNDS!","color":"dark_red"}
execute if score $gamestate CmdData matches 2.. as @a[team=!Lobby,team=!Spectator,team=!Developer,scores={drowning=3}] at @s run title @s title {"text":"OUT OF BOUNDS!","color":"white"}
execute if score $gamestate CmdData matches 2.. as @a[team=!Lobby,team=!Spectator,team=!Developer,scores={drowning=5}] at @s run title @s title {"text":"OUT OF BOUNDS!","color":"dark_red"}
execute if score $gamestate CmdData matches 2.. as @a[team=!Lobby,team=!Spectator,team=!Developer,scores={drowning=7}] at @s run title @s title {"text":"OUT OF BOUNDS!","color":"white"}
execute if score $gamestate CmdData matches 2.. as @a[team=!Lobby,team=!Spectator,team=!Developer,scores={drowning=8..}] at @s run title @s title {"text":"OUT OF BOUNDS!","color":"dark_red"}
execute if score $gamestate CmdData matches 2.. as @a[team=!Lobby,team=!Spectator,team=!Developer,scores={drowning=1..80}] at @s run title @s subtitle {"text":"Return to the combat area","color":"red"}
execute if score $gamestate CmdData matches 2.. as @a[team=!Lobby,team=!Spectator,team=!Developer,scores={drowning=20}] at @s run playsound minecraft:entity.generic.swim master @s ~ ~ ~ 1 0.7
execute if score $gamestate CmdData matches 2.. as @a[team=!Lobby,team=!Spectator,team=!Developer,scores={drowning=40}] at @s run playsound minecraft:entity.generic.swim master @s ~ ~ ~ 1 0.8
execute if score $gamestate CmdData matches 2.. as @a[team=!Lobby,team=!Spectator,team=!Developer,scores={drowning=60}] at @s run playsound minecraft:entity.generic.swim master @s ~ ~ ~ 1 1
execute if score $gamestate CmdData matches 2.. as @a[team=!Lobby,team=!Spectator,team=!Developer,predicate=!game:inarena] at @s run scoreboard players add @s drowning 1
execute if score $gamestate CmdData matches 2.. as @a[team=!Lobby,team=!Spectator,team=!Developer,scores={drowning=80..}] at @s run particle splash ~ ~ ~ 0.3 0 0.3 0.3 150 force
execute if score $gamestate CmdData matches 2.. as @a[team=!Lobby,team=!Spectator,team=!Developer,scores={drowning=80..}] at @s run particle falling_water ~ ~ ~ 0.2 0.4 0.1 0.2 150 force
execute if score $gamestate CmdData matches 2.. as @a[team=!Lobby,team=!Spectator,team=!Developer,scores={drowning=80..}] at @s run particle minecraft:bubble_column_up ~ ~ ~ 0.4 0.2 0.4 0.1 20 force
execute if score $gamestate CmdData matches 2.. as @a[team=!Lobby,team=!Spectator,team=!Developer,scores={drowning=80..}] at @s run playsound minecraft:entity.player.splash.high_speed master @a[distance=1..] ~ ~ ~ 1 0
execute if score $gamestate CmdData matches 2.. as @a[team=!Lobby,team=!Spectator,team=!Developer,scores={drowning=80..}] at @s run playsound minecraft:entity.player.splash.high_speed master @a[distance=1..] ~ ~ ~ 1 1.4
execute if score $gamestate CmdData matches 2.. as @a[team=!Lobby,team=!Spectator,team=!Developer,scores={drowning=80..}] at @s run playsound minecraft:block.bubble_column.whirlpool_ambient master @a[distance=1..] ~ ~ ~ 1 1.2
...
title @a[team=!Lobby,team=!Spectator,team=!Developer,scores={drowning=1..},predicate=game:inarena] title {"text":" ","color":"dark_red"}
title @a[team=!Lobby,team=!Spectator,team=!Developer,scores={drowning=1..},predicate=game:inarena] subtitle {"text":" ","color":"dark_red"}
scoreboard players reset @a[team=!Lobby,team=!Spectator,team=!Developer,scores={drowning=1..},predicate=game:inarena] drowning
