...
execute if entity @s[scores={CalcAir2=0..},predicate=cannons:ships/purple] run scoreboard players operation $DamagePurple CmdData += @s CalcAir2
execute if entity @s[scores={CalcAir2=0..},predicate=cannons:ships/purple] if score $InOrange CmdData >= $InPurple CmdData run scoreboard players add $DamagePurple CmdData 14
execute if entity @s[scores={CalcAir2=0..},predicate=cannons:ships/purple] if score $InOrange CmdData < $InPurple CmdData run scoreboard players add $DamagePurple CmdData 20
...
execute if entity @s[scores={CalcAir2=0..},predicate=cannons:ships/orange] run scoreboard players operation $DamageOrange CmdData += @s CalcAir2
execute if entity @s[scores={CalcAir2=0..},predicate=cannons:ships/orange] if score $InPurple CmdData >= $InOrange CmdData run scoreboard players add $DamageOrange CmdData 14
execute if entity @s[scores={CalcAir2=0..},predicate=cannons:ships/orange] if score $InPurple CmdData < $InOrange CmdData run scoreboard players add $DamageOrange CmdData 20
