...
execute if entity @s[tag=ChainImpact,scores={CalcSail1=1..},predicate=cannons:ships/abovesails,predicate=cannons:ships/orange] at @s run scoreboard players add @s CriticalDamage 12
execute if entity @s[tag=ChainImpact,scores={CalcSail1=..10},predicate=cannons:ships/abovesails,predicate=cannons:ships/orange] at @s run scoreboard players add @s CriticalDamage 8
