...
execute as @e[type=marker,tag=RingOfFire,predicate=!cannons:safezones/island,scores={CmdData=1}] at @s run tag @e[type=armor_stand,tag=CannonDisp,tag=!OnFire,distance=..6,limit=3,sort=nearest] add OnFire
