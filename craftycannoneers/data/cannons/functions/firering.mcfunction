...
execute as @e[type=marker,tag=RingOfFire,predicate=!cannons:safezones/island,predicate=!cannons:safezones/tutorial,scores={CmdData=1}] at @s run tag @e[type=armor_stand,tag=CannonDisp,tag=!OnFire,distance=..6,limit=2,sort=nearest] add OnFire
execute as @e[type=marker,tag=RingOfFire,predicate=!cannons:safezones/island,predicate=!cannons:safezones/tutorial,scores={CmdData=1}] at @s run scoreboard players reset @e[type=armor_stand,tag=CannonDisp,tag=OnFire,distance=..6,sort=nearest] firetime
execute as @e[type=marker,tag=RingOfFire,predicate=!cannons:safezones/island,predicate=!cannons:safezones/tutorial,scores={CmdData=1}] at @s run fill ~-1 ~1 ~-1 ~1 ~1 ~1 fire replace air
execute as @e[type=marker,tag=RingOfFire,predicate=!cannons:safezones/island,predicate=!cannons:safezones/tutorial,scores={CmdData=3}] at @s run fill ~-1 ~1 ~-1 ~1 ~1 ~1 air replace fire
execute as @e[type=marker,tag=RingOfFire,predicate=!cannons:safezones/island,predicate=!cannons:safezones/tutorial,scores={CmdData=3}] at @s run fill ~-2 ~2 ~-2 ~2 ~2 ~2 fire replace air
execute as @e[type=marker,tag=RingOfFire,predicate=!cannons:safezones/island,predicate=!cannons:safezones/tutorial,scores={CmdData=5}] at @s run fill ~-2 ~2 ~-2 ~2 ~2 ~2 air replace fire
execute as @e[type=marker,tag=RingOfFire,predicate=!cannons:safezones/island,predicate=!cannons:safezones/tutorial,scores={CmdData=5}] at @s run fill ~-3 ~3 ~-3 ~3 ~3 ~3 fire replace air
...
execute as @e[type=marker,tag=RingOfFire,predicate=!cannons:safezones/island,predicate=!cannons:safezones/tutorial,scores={CmdData=505}] run function cannons:extinguishfire
