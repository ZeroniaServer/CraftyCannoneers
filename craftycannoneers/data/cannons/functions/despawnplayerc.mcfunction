...
execute as @e[type=armor_stand,tag=PlayerCannonball] at @s if score @s playerUUID = $currentdesp playerUUID run kill @e[tag=PCannonballdeco,limit=1,sort=nearest]
