...
item replace entity @s[scores={firetime=1}] container.0 with minecraft:diamond_hoe[custom_model_data=63]
...
item replace entity @s[scores={firetime=400..}] container.0 with minecraft:diamond_hoe[custom_model_data=62]
