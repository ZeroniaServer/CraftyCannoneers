...
execute at @s[scores={cannonshot=30..,CmdData=3}] run summon armor_stand ~ ~1 ~ {Tags:["cannonball","CannonballCluster","1","HLeft","Hit1","NewCannonball"],Small:1b,Silent:1b,Invisible:1b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",Count:1b,tag:{CustomModelData:30}}]}
execute at @s[scores={cannonshot=30..,CmdData=3}] run summon armor_stand ~ ~1 ~ {Tags:["cannonball","CannonballCluster","2","HLeft","Hit1","NewCannonball"],Small:1b,Silent:1b,Invisible:1b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",Count:1b,tag:{CustomModelData:30}}]}
execute at @s[scores={cannonshot=30..,CmdData=3}] run summon armor_stand ~ ~1 ~ {Tags:["cannonball","CannonballCluster","3","Hit1","HRight","NewCannonball"],Small:1b,Silent:1b,Invisible:1b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",Count:1b,tag:{CustomModelData:30}}]}
execute at @s[scores={cannonshot=30..,CmdData=3}] run summon armor_stand ~ ~1 ~ {Tags:["cannonball","CannonballCluster","4","Hit1","HRight","NewCannonball"],Small:1b,Silent:1b,Invisible:1b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",Count:1b,tag:{CustomModelData:30}}]}
...
execute at @s[scores={cannonshot=30..,CmdData=5}] run summon armor_stand ~ ~1 ~ {Tags:["cannonball","ChainCannonball","NewCannonball"],Small:1b,Silent:1b,Invisible:1b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",Count:1b,tag:{CustomModelData:40}}],Passengers:[{id:"minecraft:armor_stand",Invisible:1b,Marker:1b,Small:1b,Tags:["ChainAnchor"]}]}
