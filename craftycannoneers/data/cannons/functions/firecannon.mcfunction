...
execute at @s[tag=Purple,scores={cannonshot=30..,CmdData=3}] run summon armor_stand ~ ~1 ~ {Tags:["cannonball","CannonballCluster","1","HLeft","Hit1","NewCannonball"],Rotation:[0.0f,0.0f],Small:1b,Silent:1b,Invisible:1b,Invulnerable:1b}
execute at @s[tag=Purple,scores={cannonshot=30..,CmdData=3}] run summon armor_stand ~ ~1 ~ {Tags:["cannonball","CannonballCluster","2","HLeft","Hit1","NewCannonball"],Rotation:[0.0f,0.0f],Small:1b,Silent:1b,Invisible:1b,Invulnerable:1b}
execute at @s[tag=Purple,scores={cannonshot=30..,CmdData=3}] run summon armor_stand ~ ~1 ~ {Tags:["cannonball","CannonballCluster","3","Hit1","HRight","NewCannonball"],Rotation:[0.0f,0.0f],Small:1b,Silent:1b,Invisible:1b,Invulnerable:1b}
execute at @s[tag=Purple,scores={cannonshot=30..,CmdData=3}] run summon armor_stand ~ ~1 ~ {Tags:["cannonball","CannonballCluster","4","Hit1","HRight","NewCannonball"],Rotation:[0.0f,0.0f],Small:1b,Silent:1b,Invisible:1b,Invulnerable:1b}
...
execute at @s[tag=Orange,scores={cannonshot=30..,CmdData=3}] run summon armor_stand ~ ~1 ~ {Tags:["cannonball","CannonballCluster","1","HLeft","Hit1","NewCannonball"],Rotation:[180.0f,0.0f],Small:1b,Silent:1b,Invisible:1b,Invulnerable:1b}
execute at @s[tag=Orange,scores={cannonshot=30..,CmdData=3}] run summon armor_stand ~ ~1 ~ {Tags:["cannonball","CannonballCluster","2","HLeft","Hit1","NewCannonball"],Rotation:[180.0f,0.0f],Small:1b,Silent:1b,Invisible:1b,Invulnerable:1b}
execute at @s[tag=Orange,scores={cannonshot=30..,CmdData=3}] run summon armor_stand ~ ~1 ~ {Tags:["cannonball","CannonballCluster","3","Hit1","HRight","NewCannonball"],Rotation:[180.0f,0.0f],Small:1b,Silent:1b,Invisible:1b,Invulnerable:1b}
execute at @s[tag=Orange,scores={cannonshot=30..,CmdData=3}] run summon armor_stand ~ ~1 ~ {Tags:["cannonball","CannonballCluster","4","Hit1","HRight","NewCannonball"],Rotation:[180.0f,0.0f],Small:1b,Silent:1b,Invisible:1b,Invulnerable:1b}
