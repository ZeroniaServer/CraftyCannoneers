...
execute unless entity @s[tag=Spotted] as @a[team=Purple] if score @s playerUUID = $tempuuid playerUUID run tellraw @a[team=Purple] ["",{"selector":"@s"},{"text":" destroyed an uexposed weakpoint. No bonus damage dealt.","color":"dark_aqua"}]
