...
execute as @a[tag=FillLeft,tag=HoldGP,advancements={tutorial:objectives/objective4=true}] run advancement grant @s only tutorial:objectives/objective5
execute as @a[tag=FillRight,tag=HoldGP,advancements={tutorial:objectives/objective4=true}] run advancement grant @s only tutorial:objectives/objective5
