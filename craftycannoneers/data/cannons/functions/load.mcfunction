...
execute as @e[type=armor_stand,tag=DisplayGP,scores={gpdisp_time=40..}] at @s run kill @e[type=area_effect_cloud,tag=GPDispText,tag=1,limit=1,sort=nearest,distance=..2]
execute as @e[type=armor_stand,tag=DisplayGP,scores={gpdisp_time=40..}] at @s run kill @e[type=area_effect_cloud,tag=GPDispText,tag=2,limit=1,sort=nearest,distance=..2]
