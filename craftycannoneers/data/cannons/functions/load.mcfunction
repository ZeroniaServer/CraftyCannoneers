...
#> Take gunpowder
execute as @a[tag=FillLeft,tag=!HoldGP] at @s if entity @e[tag=GPDispL,limit=1,sort=nearest,distance=..3,scores={CmdData=1..}] run give @s gunpowder{display:{Name:'[{"text":"Gunpowder","italic":false,"color":"dark_aqua"}]',Lore:['[{"text":"Used to change the power of a cannon shot.","italic":false,"color":"white"}]']}} 1
execute as @a[tag=FillLeft,tag=!HoldGP] at @s if entity @e[tag=GPDispL,limit=1,sort=nearest,distance=..3,scores={CmdData=1..}] run playsound minecraft:block.sand.hit master @a ~ ~ ~ 0.6 2
execute as @a[tag=FillLeft,tag=!HoldGP] at @s if entity @e[tag=GPDispL,limit=1,sort=nearest,distance=..3,scores={CmdData=1..}] run scoreboard players remove @e[tag=GPDispL,limit=1,sort=nearest,distance=..3,scores={CmdData=1..}] CmdData 1
execute as @a[tag=FillLeft,tag=!HoldGP] run function cannons:updategp

execute as @a[tag=FillRight,tag=!HoldGP] at @s if entity @e[tag=GPDispR,limit=1,sort=nearest,distance=..3,scores={CmdData=1..}] run give @s gunpowder{display:{Name:'[{"text":"Gunpowder","italic":false,"color":"dark_aqua"}]',Lore:['[{"text":"Used to change the power of a cannon shot.","italic":false,"color":"white"}]']}} 1
execute as @a[tag=FillRight,tag=!HoldGP] at @s if entity @e[tag=GPDispR,limit=1,sort=nearest,distance=..3,scores={CmdData=1..}] run playsound minecraft:block.sand.hit master @a ~ ~ ~ 0.6 2
execute as @a[tag=FillRight,tag=!HoldGP] at @s if entity @e[tag=GPDispR,limit=1,sort=nearest,distance=..3,scores={CmdData=1..}] run scoreboard players remove @e[tag=GPDispR,limit=1,sort=nearest,distance=..3,scores={CmdData=1..}] CmdData 1
execute as @a[tag=FillRight,tag=!HoldGP] run function cannons:updategp
