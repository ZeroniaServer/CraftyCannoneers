...
execute if entity @s[team=!Lobby,tag=FillCB,tag=HoldCB] unless entity @e[type=armor_stand,tag=CannonDisp,scores={CmdData=1..},limit=1,sort=nearest,distance=..3] run tag @s add UsedCB
...
execute if entity @s[team=!Lobby,tag=FillCB,tag=HoldFB] unless entity @e[type=armor_stand,tag=CannonDisp,scores={CmdData=1..},limit=1,sort=nearest,distance=..3] run tag @s add UsedFB
...
execute if entity @s[team=!Lobby,tag=FillCB,tag=HoldCBC] unless entity @e[type=armor_stand,tag=CannonDisp,scores={CmdData=1..},limit=1,sort=nearest,distance=..3] run tag @s add UsedCBC
...
execute if entity @s[team=!Lobby,tag=FillCB,tag=HoldGCB] unless entity @e[type=armor_stand,tag=CannonDisp,scores={CmdData=1..},limit=1,sort=nearest,distance=..3] run tag @s add UsedGCB
...
execute if entity @s[team=!Lobby,tag=FillCB,tag=HoldCCB] unless entity @e[type=armor_stand,tag=CannonDisp,scores={CmdData=1..},limit=1,sort=nearest,distance=..3] run tag @s add UsedCCB
...
execute if entity @s[team=!Lobby,tag=FillCB,tag=HoldBCB] unless entity @e[type=armor_stand,tag=CannonDisp,scores={CmdData=1..},limit=1,sort=nearest,distance=..3] run tag @s add UsedBCB
...
scoreboard players add @s[team=!Lobby,tag=FillCB,tag=HoldBCB,tag=UsedBCB] 1
#Player
...
execute if entity @s[team=!Lobby,tag=FillCB,tag=HoldPCB] unless entity @e[type=armor_stand,tag=CannonDisp,scores={CmdData=1..},limit=1,sort=nearest,distance=..3] run tag @s add UsedPCB
...
execute if entity @s[team=!Lobby,tag=FillCB,tag=HoldTCB] unless entity @e[type=armor_stand,tag=CannonDisp,scores={CmdData=1..},limit=1,sort=nearest,distance=..3] run tag @s add UsedTCB
...
execute if entity @s[team=!Lobby,tag=FillCB,tag=HoldGOCB] unless entity @e[type=armor_stand,tag=CannonDisp,scores={CmdData=1..},limit=1,sort=nearest,distance=..3] run tag @s add UsedGOCB
