...
execute unless score $landed CmdData matches 1 at @s[tag=ChainCannonball,scores={CmdData=4..}] rotated as @e[type=armor_stand,tag=ChainAnchor,limit=1,sort=nearest] unless block ^ ^ ^3 air run scoreboard players set $landed CmdData 1
...
execute unless score $landed CmdData matches 1 at @s[tag=ChainCannonball,scores={CmdData=4..}] rotated as @e[type=armor_stand,tag=ChainAnchor,limit=1,sort=nearest] unless block ^ ^ ^1 air run scoreboard players set $landed CmdData 1
execute unless score $landed CmdData matches 1 at @s[tag=ChainCannonball,scores={CmdData=4..}] rotated as @e[type=armor_stand,tag=ChainAnchor,limit=1,sort=nearest] unless block ^ ^ ^-1 air run scoreboard players set $landed CmdData 1
execute unless score $landed CmdData matches 1 at @s[tag=ChainCannonball,scores={CmdData=4..}] rotated as @e[type=armor_stand,tag=ChainAnchor,limit=1,sort=nearest] unless block ^ ^ ^-3 air run scoreboard players set $landed CmdData 1
