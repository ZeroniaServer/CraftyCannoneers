...
execute unless entity @e[type=armor_stand,tag=CurrentCheck] if entity @e[type=armor_stand,tag=CannonDisp,tag=!CurrentCheck,distance=..2] run tellraw @s {"text":"This Cannon is currently occupied!","italic":true,"color":"red"}
