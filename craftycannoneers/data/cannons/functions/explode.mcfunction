...
execute as @s[tag=InSafezone,tag=Hit1,tag=!BouncyCannonball,scores={doublehit=4..}] at @s run summon marker ^ ^ ^1 {Tags:["ImpactMarker","Power1"]}

execute as @s[tag=!InSafezone,tag=!Hit1,tag=!BouncyCannonball,tag=!ChainCannonball] at @s run summon marker ^ ^ ^1 {Tags:["ImpactMarker","Power3"]}

execute as @s[tag=!InSafezone,tag=Hit1,tag=!BouncyCannonball,tag=!ChainCannonball,scores={doublehit=4..},tag=!ChainCannonball] at @s run summon marker ^ ^ ^1 {Tags:["ImpactMarker","Power2"]}
