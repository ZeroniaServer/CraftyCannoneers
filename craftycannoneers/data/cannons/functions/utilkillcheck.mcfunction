...
execute if entity @s[team=Orange,tag=GoldKilled] as @a[team=Purple] if score @s playerUUID = #current KillerUUID at @s run playsound minecraft:entity.item.pickup player @s ~ ~ ~ 0.25 2
...
execute if entity @s[team=Purple,tag=GoldKilled] as @a[team=Orange] if score @s playerUUID = #current KillerUUID at @s run playsound minecraft:entity.item.pickup player @s ~ ~ ~ 0.25 2
