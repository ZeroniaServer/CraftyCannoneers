...
item replace entity @s[tag=BouncyCannonball] armor.head with diamond_hoe{CustomModelData:55}
item replace entity @s[tag=GoldenCannonball] armor.head with diamond_hoe{CustomModelData:73}
item replace entity @s[tag=CopperCannonball] armor.head with diamond_hoe{CustomModelData:109}