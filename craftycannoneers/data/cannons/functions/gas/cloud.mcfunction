...
execute at @s[scores={CmdData=1}] run summon bat ~ ~2 ~ {Tags:["GasBat"],Silent:1b,Invulnerable:1b,DeathTime:17s,DeathLootTable:"minecraft:empty",ActiveEffects:[{Id:14,Duration:-1,Amplifier:0,ShowParticles:false}]}
execute at @s[scores={CmdData=1}] run summon bat ~ ~2 ~ {Tags:["GasBat"],Silent:1b,Invulnerable:1b,DeathTime:17s,DeathLootTable:"minecraft:empty",ActiveEffects:[{Id:14,Duration:-1,Amplifier:0,ShowParticles:false}]}
execute at @s[scores={CmdData=1}] run summon bat ~ ~2 ~ {Tags:["GasBat"],Silent:1b,Invulnerable:1b,DeathTime:17s,DeathLootTable:"minecraft:empty",ActiveEffects:[{Id:14,Duration:-1,Amplifier:0,ShowParticles:false}]}
execute at @s[scores={CmdData=1}] run summon bat ~ ~2 ~ {Tags:["GasBat"],Silent:1b,Invulnerable:1b,DeathTime:17s,DeathLootTable:"minecraft:empty",ActiveEffects:[{Id:14,Duration:-1,Amplifier:0,ShowParticles:false}]}
execute at @s[scores={CmdData=1}] run summon bat ~ ~2 ~ {Tags:["GasBat"],Silent:1b,Invulnerable:1b,DeathTime:17s,DeathLootTable:"minecraft:empty",ActiveEffects:[{Id:14,Duration:-1,Amplifier:0,ShowParticles:false}]}
