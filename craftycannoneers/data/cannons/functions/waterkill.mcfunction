...
execute if entity @s[tag=BouncyCannonball] run particle item diamond_hoe{CustomModelData:55} ^ ^1 ^-6 0 0 0 0.1 40 force @a[predicate=cannons:seeparticles]
...
tag @s add InWater
particle minecraft:splash ^ ^1 ^-6 0.3 0.5 0.3 0.2 100 force @a[predicate=cannons:seeparticles]
particle minecraft:falling_water ^ ^1.3 ^-6 0.3 0.5 0.3 0.1 100 force @a[predicate=cannons:seeparticles]
