...
scoreboard players set @s gravity 65
...
execute if entity @s[scores={RNGscore=..60}] run tag @s add HLeft
execute if entity @s[scores={RNGscore=61..120}] run tag @s add HRight
