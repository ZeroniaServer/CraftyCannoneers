...
summon villager ~ ~0.5 ~-0.3 {NoAI:1b,Silent:1b,Invulnerable:1b,NoGravity:1b,Age:-2147483648,Tags:["CannonVMain","cannon","Purple","NoID"],PersistenceRequired:1b,DeathTime:19s,Passengers:[{id:"minecraft:marker",Tags:["villager","NoID"],data:{Tags:["CannonVMain","cannon","Purple"]}}]}
summon villager ~0.5 ~0.5 ~-0.5 {NoAI:1b,Silent:1b,Invulnerable:1b,NoGravity:1b,Age:-2147483648,Tags:["CannonVLeft","cannon","Purple","NoID"],PersistenceRequired:1b,DeathTime:19s,Passengers:[{id:"minecraft:marker",Tags:["villager","NoID"],data:{Tags:["CannonVLeft","cannon","Purple"]}}]}
summon villager ~-0.5 ~0.5 ~-0.5 {NoAI:1b,Silent:1b,Invulnerable:1b,NoGravity:1b,Age:-2147483648,Tags:["CannonVRight","cannon","Purple","NoID"],PersistenceRequired:1b,DeathTime:19s,Passengers:[{id:"minecraft:marker",Tags:["villager","NoID"],data:{Tags:["CannonVRight","cannon","Purple"]}}]}
