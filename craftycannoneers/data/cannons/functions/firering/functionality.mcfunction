...
execute if entity @s[tag=!ignited] run tag @e[type=armor_stand,tag=GasBubble,distance=..3] add GasIgnite
...
execute if entity @e[type=armor_stand,tag=GasBubble,distance=..3] run tag @s add ignited
