...
execute if entity @s[tag=Purple] if score $DamagePurple CmdData >= $PurpleHP CmdData as @a[team=Orange] if score @s playerUUID = $tempuuid playerUUID run scoreboard players operation @s MVPdamage += $CurrentDamage CmdData
...
execute if entity @s[tag=Orange] if score $DamageOrange CmdData >= $OrangeHP CmdData as @a[team=Purple] if score @s playerUUID = $tempuuid playerUUID run scoreboard players operation @s MVPdamage += $CurrentDamage CmdData
