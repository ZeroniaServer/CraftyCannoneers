...
execute as @s at @s run particle glow_squid_ink ~ ~ ~ 0 0 0 0 0.05 force @a[tag=CurrentTracer]
execute as @s at @s run particle dust 0 1 0.2 1.4 ~ ~ ~ 0 0 0 0 0 force @a[tag=CurrentTracer]
