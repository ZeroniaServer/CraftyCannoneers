...
execute as @s at @s run particle glow_squid_ink ~ ~ ~ 0 0 0 0.02 1 force @a[tag=CurrentTracer]
execute as @s at @s run particle glow ~ ~ ~ 0 0 0 0.07 2 force @a[tag=CurrentTracer]
execute as @s at @s run particle dust 0 1 0.2 4 ~ ~ ~ 0 0 0 0 2 force @a[tag=CurrentTracer]
