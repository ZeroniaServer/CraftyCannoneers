...
execute if entity @s[tag=BlastBarrel1] run summon creeper ~ ~ ~ {Tags:["BlastBarrelCreeper","CannonballCreeper"],CustomName:'{"translate":"item.blast_barrel"}',Fuse:1,Silent:1b,CustomNameVisible:0b,NoAI:1b,CanPickUpLoot:0b,DeathTime:19s,ExplosionRadius:2}
execute if entity @s[tag=BlastBarrel1] run summon creeper ~ ~ ~ {Tags:["BlastBarrelCreeper","CannonballCreeper"],CustomName:'{"translate":"item.blast_barrel"}',Fuse:1,Silent:1b,CustomNameVisible:0b,NoAI:1b,CanPickUpLoot:0b,DeathTime:19s,ExplosionRadius:2}
execute if entity @s[tag=BlastBarrel2] run summon creeper ~ ~ ~ {Invulnerable:1b,Tags:["BlastBarrelCreeper","CannonballCreeper"],CustomName:'{"translate":"item.blast_barrel"}',Fuse:1,Silent:1b,CustomNameVisible:0b,NoAI:1b,CanPickUpLoot:0b,DeathTime:19s,ExplosionRadius:3}
execute if entity @s[tag=BlastBarrel2] run summon creeper ~ ~ ~ {Invulnerable:1b,Tags:["BlastBarrelCreeper","CannonballCreeper"],CustomName:'{"translate":"item.blast_barrel"}',Fuse:1,Silent:1b,CustomNameVisible:0b,NoAI:1b,CanPickUpLoot:0b,DeathTime:19s,ExplosionRadius:2}
team join Collide @e[type=creeper,tag=BlastBarrelCreeper]
execute if entity @s[tag=GasPower,predicate=!cannons:safezones/island,predicate=!cannons:safezones/tutorial] run summon creeper ~ ~ ~ {Tags:["GasCreeper","CannonballCreeper"],CustomName:'{"translate":"gas_explosion.generic"}',Fuse:1,Silent:1b,CustomNameVisible:0b,NoAI:1b,CanPickUpLoot:0b,DeathTime:19s,ExplosionRadius:2}
