...
execute if entity @s[tag=BlastBarrel1] run summon creeper ~ ~ ~ {Tags:["CannonballCreeper"],CustomName:'{"translate":"item.blast_barrel"}',Fuse:1,Silent:1b,CustomNameVisible:0b,NoAI:1b,CanPickUpLoot:0b,DeathTime:19s,ExplosionRadius:2}
execute if entity @s[tag=BlastBarrel1] run summon creeper ~ ~ ~ {Tags:["CannonballCreeper"],CustomName:'{"translate":"item.blast_barrel"}',Fuse:1,Silent:1b,CustomNameVisible:0b,NoAI:1b,CanPickUpLoot:0b,DeathTime:19s,ExplosionRadius:2}
execute if entity @s[tag=BlastBarrel2] run summon creeper ~ ~ ~ {Invulnerable:1b,Tags:["BlastBarrelCreeper"],CustomName:'{"translate":"item.blast_barrel"}',Fuse:0,Silent:1b,CustomNameVisible:0b,NoAI:1b,CanPickUpLoot:0b,DeathTime:19s,ExplosionRadius:-1,Team:"Collide"}
# execute if entity @s[tag=BlastBarrel2] run summon creeper ~ ~ ~ {Tags:["CannonballCreeper","BlastBarrelCreeper"],CustomName:'{"translate":"item.blast_barrel"}',Fuse:1,Silent:1b,CustomNameVisible:0b,NoAI:1b,CanPickUpLoot:0b,DeathTime:19s,ExplosionRadius:-1,Team:"Collide"}
