...
execute at @s[tag=GPDispL,scores={gpdisp_time=1}] at @e[type=villager,tag=CannonVRight,tag=!Tutorial,limit=1,sort=nearest,distance=..2] run summon area_effect_cloud ~ ~0.2 ~ {Tags:["cannon","GPDispText","2"],Duration:2000000000,Particle:"block air"}
execute at @s[tag=GPDispL,scores={gpdisp_time=1}] at @e[type=villager,tag=CannonVLeft,tag=Tutorial,limit=1,sort=nearest,distance=..2] run summon area_effect_cloud ~ ~0.2 ~ {Tags:["cannon","GPDispText","1","Tutorial"],Duration:2000000000,Particle:"block air"}
execute at @s[tag=GPDispL,scores={gpdisp_time=1}] at @e[type=villager,tag=CannonVRight,tag=Tutorial,limit=1,sort=nearest,distance=..2] run summon area_effect_cloud ~ ~0.2 ~ {Tags:["cannon","GPDispText","2","Tutorial"],Duration:2000000000,Particle:"block air"}
