execute unless predicate cannons:safezones/tutorial store result score @s CalcAir1 run fill ~5 ~5 ~5 ~-5 ~-5 ~-5 light[level=0] replace air
execute unless predicate cannons:safezones/tutorial run fill ~5 ~5 ~5 ~-5 ~-5 ~-5 air replace light[level=0]

execute unless predicate cannons:safezones/tutorial store result score @s CalcFire1 run fill ~5 ~5 ~5 ~-5 ~-5 ~-5 light[level=0] replace fire
