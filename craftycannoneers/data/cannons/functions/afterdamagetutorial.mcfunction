...
execute if predicate cannons:ships/tutorial run scoreboard players reset $hitmarkuuid
execute if predicate cannons:ships/tutorial if score $shipstatus CmdData matches 0 run scoreboard players set $shipstatus CmdData 1
execute if predicate cannons:ships/tutorial if score $shiptimer CmdData matches 0 run scoreboard players add $shiptimer CmdData 1
