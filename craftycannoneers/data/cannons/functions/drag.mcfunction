...
execute as @e[tag=CannonballShot] if score @s x matches 500.. run scoreboard players operation @s x -= @s drag
execute as @e[tag=CannonballShot] if score @s x matches ..-500 run scoreboard players operation @s x += @s drag
execute as @e[tag=CannonballShot] if score @s z matches 500.. run scoreboard players operation @s z -= @s drag
execute as @e[tag=CannonballShot] if score @s z matches ..-500 run scoreboard players operation @s z += @s drag
# y velocity only needs a lower cap bc gravity just keeps going down
execute as @e[tag=CannonballShot] if score @s y matches -500.. run scoreboard players operation @s y -= @s gravity
