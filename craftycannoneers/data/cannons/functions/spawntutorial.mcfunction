...
summon villager ~0.3 ~0.5 ~ {NoAI:1b,Silent:1b,Invulnerable:1b,NoGravity:1b,Age:-2147483648,Tags:["CannonVMain","cannon","Tutorial","NoID"],PersistenceRequired:1b,Passengers:[{id:"minecraft:marker",Tags:["villager","NoID","Tutorial"],data:{Tags:["CannonVMain","cannon","Tutorial"]}}]}
summon villager ~0.5 ~0.5 ~-0.5 {NoAI:1b,Silent:1b,Invulnerable:1b,NoGravity:1b,Age:-2147483648,Tags:["CannonVRight","cannon","Tutorial","NoID"],PersistenceRequired:1b,Passengers:[{id:"minecraft:marker",Tags:["villager","NoID","Tutorial"],data:{Tags:["CannonVRight","cannon","Tutorial"]}}]}
summon villager ~0.5 ~0.5 ~0.5 {NoAI:1b,Silent:1b,Invulnerable:1b,NoGravity:1b,Age:-2147483648,Tags:["CannonVLeft","cannon","Tutorial","NoID"],PersistenceRequired:1b,Passengers:[{id:"minecraft:marker",Tags:["villager","NoID","Tutorial"],data:{Tags:["CannonVLeft","cannon","Tutorial"]}}]}
