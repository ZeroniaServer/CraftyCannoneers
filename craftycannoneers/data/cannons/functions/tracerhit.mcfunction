...
particle block_marker lime_concrete ~ ~ ~ 0.5 0.5 0 0 20 force @a[tag=CurrentTracer2]
particle block_marker green_concrete ~ ~ ~ 0 0 0.5 0 5 force @a[tag=CurrentTracer2]
