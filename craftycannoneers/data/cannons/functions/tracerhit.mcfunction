...
particle block_marker lime_concrete ~ ~ ~ 1 1 1 0 20 force @a[tag=CurrentTracer2]

give @a[tag=CurrentTracer2] diamond_hoe{NoDrop:1b,Unbreakable:1b,CustomModelData:60,Cannonball:8b,display:{Name:'[{"text":"Tracer Cannonball","italic":false,"color":"dark_aqua"}]',Lore:['[{"text":"Using this Cannonball does not","italic":false,"color":"white"}]','[{"text":"consume any Gunpowder in a Cannon.","italic":false,"color":"white"},{"text":"","italic":false,"color":"dark_purple"}]','[{"text":"","italic":false,"color":"dark_purple"}]','[{"text":"Leaves behind a visible trail","italic":false,"color":"#66ff99"}]','[{"text":"which is only visible to its user.","italic":false,"color":"#66ff99"},{"text":"","italic":false,"color":"dark_purple"}]','[{"text":"","italic":false,"color":"dark_purple"}]']}}
