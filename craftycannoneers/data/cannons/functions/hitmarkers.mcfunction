...
execute unless score $gamestate CmdData matches 3 run scoreboard players set @s[scores={HitmarkerType=0,HitmarkerTimer=5..}] HitmarkerTimer 8
...
execute unless score $gamestate CmdData matches 3 run scoreboard players set @s[scores={HitmarkerType=1,HitmarkerTimer=6..}] HitmarkerTimer 8
...
execute unless score $gamestate CmdData matches 3 run title @s[scores={HitmarkerTimer=8}] title {"text":" "}
execute unless score $gamestate CmdData matches 3 run title @s[scores={HitmarkerTimer=8}] subtitle {"text":" "}
