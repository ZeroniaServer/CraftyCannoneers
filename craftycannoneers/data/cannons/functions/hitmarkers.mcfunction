...
execute as @a[scores={HitmarkerType=0,HitmarkerTimer=2}] at @s run playsound hitmarker_normal master @s ~ ~ ~ 1 1

execute as @a[scores={HitmarkerType=1,HitmarkerTimer=2}] run title @s title {"text":"\uE001"}
execute as @a[scores={HitmarkerType=1,HitmarkerTimer=2}] at @s run playsound hitmarker_critical master @s ~ ~ ~ 1 1

execute as @a[scores={HitmarkerType=2,HitmarkerTimer=2}] run title @s title {"text":"\uE002"}
execute as @a[scores={HitmarkerType=2,HitmarkerTimer=2}] at @s run playsound hitmarker_kill master @s ~ ~ ~ 1 1
