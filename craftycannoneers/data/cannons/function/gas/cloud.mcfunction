...
execute at @s[scores={CmdData=1}] run summon item_display ~ ~ ~ {Tags:["gascloud"],Passengers:[{id:"item_display",Tags:["gascloud","GasDisplay"],item:{id:"minecraft:diamond_hoe",count:1,components:{"custom_model_data":{floats:[33.0f]}}},item_display:"head",transformation:{translation:[0f,-1f,0f],scale:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},width:3f,height:3f,brightness:{sky:10,block:12}}]}
