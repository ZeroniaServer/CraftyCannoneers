...
execute at @s[tag=GPDispL,scores={gpdisp_time=1}] at @e[type=interaction,tag=CannonVLeft,tag=!Tutorial,limit=1,sort=nearest,distance=..2] run summon area_effect_cloud ~ ~ ~ {Tags:["cannon","GPDispText","1"],Duration:2000000000,Particle:{type:"block",block_state:"minecraft:air"}}
execute at @s[tag=GPDispL,scores={gpdisp_time=1}] at @e[type=interaction,tag=CannonVRight,tag=!Tutorial,limit=1,sort=nearest,distance=..2] run summon area_effect_cloud ~ ~ ~ {Tags:["cannon","GPDispText","2"],Duration:2000000000,Particle:{type:"block",block_state:"minecraft:air"}}
execute at @s[tag=GPDispL,scores={gpdisp_time=1}] at @e[type=interaction,tag=CannonVLeft,tag=Tutorial,limit=1,sort=nearest,distance=..2] run summon area_effect_cloud ~ ~ ~ {Tags:["cannon","GPDispText","1","Tutorial"],Duration:2000000000,Particle:{type:"block",block_state:"minecraft:air"}}
execute at @s[tag=GPDispL,scores={gpdisp_time=1}] at @e[type=interaction,tag=CannonVRight,tag=Tutorial,limit=1,sort=nearest,distance=..2] run summon area_effect_cloud ~ ~ ~ {Tags:["cannon","GPDispText","2","Tutorial"],Duration:2000000000,Particle:{type:"block",block_state:"minecraft:air"}}
