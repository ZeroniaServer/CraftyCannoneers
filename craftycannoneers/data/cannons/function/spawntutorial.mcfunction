summon item_display ~ ~ ~ {Tags:["cannon","CannonCart","Tutorial","CannonDisp","NoID"],item_display:"head",Rotation:[90.0f,0.0f],width:2.5f,height:2f}
summon item_display ~ ~ ~ {Tags:["cannon","CannonBarrel","Tutorial","CannonDisp","NoID"],item_display:"head",Rotation:[90.0f,0.0f],width:2.5f,height:2f}
...
item replace entity @e[type=item_display,tag=CannonCart,tag=NoID,limit=1] container.0 with minecraft:diamond_hoe[custom_model_data={floats:[1.0f]}]
item replace entity @e[type=item_display,tag=CannonBarrel,tag=NoID,limit=1] container.0 with minecraft:diamond_hoe[custom_model_data={floats:[62.0f]}]
