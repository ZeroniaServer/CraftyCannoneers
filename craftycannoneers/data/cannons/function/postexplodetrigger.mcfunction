summon area_effect_cloud ~ ~10000 ~ {Tags:["postexplode"],custom_particle:{type:"block",block_state:"minecraft:air"},Duration:1,Radius:0.0f,ReapplicationDelay:-1,Age:-1,WaitTime:0,potion_contents:{custom_effects:[{id:"minecraft:instant_damage",amplifier:0,duration:1}]}}
