...
execute unless score $OrangeWPDelay CmdData matches 1.. if entity @s[tag=HitSpotted,tag=!WeakpointAnnounced] run tellraw @a[team=Spectator] ["\n",{translate:"weakpoint.destroyed",color:"dark_aqua",with:[{selector:"@s",color:"dark_aqua"},{translate:"weakpoint.destroyed.exposed",underlined:true,color:"dark_green"},""]},"\n"]
...
execute if score $OrangeWPDelay CmdData matches 1.. run return fail
