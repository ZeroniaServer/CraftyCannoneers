...
execute unless entity @a[limit=1,tag=SetCannonName,team=Lobby] unless entity @e[type=area_effect_cloud,tag=CannonNametag,tag=!New,distance=..2] run summon area_effect_cloud ~ ~1.2 ~ {Duration:2000000000,Tags:["CannonNametag","New"],CustomNameVisible:1b,Particle:{type:"block",block_state:"minecraft:air"}}
execute if entity @a[limit=1,tag=SetCannonName,team=Lobby] unless entity @e[type=area_effect_cloud,tag=CannonNametag,tag=!New,distance=..2] run summon area_effect_cloud ~ ~1.2 ~ {Duration:2000000000,Tags:["CannonNametag","New","Tutorial"],CustomNameVisible:1b,Particle:{type:"block",block_state:"minecraft:air"}}
