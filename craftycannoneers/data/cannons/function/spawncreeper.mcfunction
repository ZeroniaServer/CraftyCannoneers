...
execute if entity @s[tag=!GoldImpact,tag=!cluster,tag=!GasPower] as @a[tag=UtilKilled,distance=..2] at @s run summon area_effect_cloud ~ ~ ~ {Tags:["damage"],Particle:{type:"block",block_state:"minecraft:air"},ReapplicationDelay:-1,Radius:0.1f,Duration:2,Age:-1,WaitTime:0,effects:[{id:"minecraft:instant_damage",amplifier:3b,duration:1,show_particles:0b}]}
execute if entity @s[tag=!GoldImpact,tag=!cluster,tag=!GasPower] run tag @a[tag=UtilKilled,distance=..2] add damaged
execute if entity @s[tag=!GoldImpact,tag=!cluster,tag=!GasPower] as @a[tag=UtilKilled,tag=!damaged,distance=..4] at @s run summon area_effect_cloud ~ ~ ~ {Tags:["damage"],Particle:{type:"block",block_state:"minecraft:air"},ReapplicationDelay:-1,Radius:0.1f,Duration:2,Age:-1,WaitTime:0,effects:[{id:"minecraft:instant_damage",amplifier:2b,duration:1,show_particles:0b}]}
execute if entity @s[tag=!GoldImpact,tag=!cluster,tag=!GasPower] run tag @a[tag=UtilKilled,tag=!damaged,distance=..4] add damaged
execute if entity @s[tag=!GoldImpact,tag=!cluster,tag=!GasPower] as @a[tag=UtilKilled,tag=!damaged,distance=..5] at @s run summon area_effect_cloud ~ ~ ~ {Tags:["damage"],Particle:{type:"block",block_state:"minecraft:air"},ReapplicationDelay:-1,Radius:0.1f,Duration:2,Age:-1,WaitTime:0,effects:[{id:"minecraft:instant_damage",amplifier:1b,duration:1,show_particles:0b}]}
execute if entity @s[tag=!GoldImpact,tag=!cluster,tag=!GasPower] run tag @a[tag=UtilKilled,tag=!damaged,distance=..5] add damaged
execute if entity @s[tag=!GoldImpact,tag=!cluster,tag=!GasPower] as @a[tag=UtilKilled,tag=!damaged,distance=..6] at @s run summon area_effect_cloud ~ ~ ~ {Tags:["damage"],Particle:{type:"block",block_state:"minecraft:air"},ReapplicationDelay:-1,Radius:0.1f,Duration:2,Age:-1,WaitTime:0,effects:[{id:"minecraft:instant_damage",amplifier:0b,duration:1,show_particles:0b}]}
...
execute if entity @s[tag=GoldImpact] as @a[tag=UtilKilled,distance=..6] if entity @s[predicate=game:onorange,team=Orange] run summon area_effect_cloud ~ ~ ~ {Tags:["damage"],Particle:{type:"block",block_state:"minecraft:air"},ReapplicationDelay:-1,Radius:0.1f,Duration:2,Age:-1,WaitTime:0,effects:[{id:"minecraft:instant_damage",amplifier:2b,duration:1,show_particles:0b}]}
execute if entity @s[tag=GoldImpact] as @a[tag=UtilKilled,distance=..6] if entity @s[predicate=game:onpurple,team=Purple] run summon area_effect_cloud ~ ~ ~ {Tags:["damage"],Particle:{type:"block",block_state:"minecraft:air"},ReapplicationDelay:-1,Radius:0.1f,Duration:2,Age:-1,WaitTime:0,effects:[{id:"minecraft:instant_damage",amplifier:2b,duration:1,show_particles:0b}]}
