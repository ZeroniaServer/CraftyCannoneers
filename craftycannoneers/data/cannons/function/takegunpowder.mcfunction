...
execute if entity @s[tag=FillLeft] at @e[type=item_display,tag=GPDispL,scores={CmdData=7},limit=1,sort=nearest,distance=..1.4] run data modify entity @e[type=interaction,tag=CannonVLeft,limit=1,sort=nearest] response set value 1b
...
execute if entity @s[tag=FillRight] at @e[type=item_display,tag=GPDispR,scores={CmdData=7},limit=1,sort=nearest,distance=..1.4] run data modify entity @e[type=interaction,tag=CannonVRight,limit=1,sort=nearest] response set value 1b
