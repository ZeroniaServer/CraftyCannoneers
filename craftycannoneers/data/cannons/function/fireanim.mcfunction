...
item replace entity @s[scores={firetime=1}] container.0 with minecraft:diamond_hoe[custom_model_data={floats:[63.0f]}]
...
item replace entity @s[scores={firetime=400..}] container.0 with minecraft:diamond_hoe[custom_model_data={floats:[62.0f]}]
