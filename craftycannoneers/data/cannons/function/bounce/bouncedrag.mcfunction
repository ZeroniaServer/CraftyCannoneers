...
execute store result storage craftycannoneers:cannonball Motion[0] double 0.002 run scoreboard players get @s x
execute store result storage craftycannoneers:cannonball Motion[1] double 0.001 run scoreboard players get @s y
execute store result storage craftycannoneers:cannonball Motion[2] double 0.002 run scoreboard players get @s z
