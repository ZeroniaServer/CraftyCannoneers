tp @s ~ -20.25 ~
execute at @s run summon area_effect_cloud ~ ~0.625 ~ {Tags:["ParkourNameAEC"],Duration:200000000,CustomNameVisible:1b,Radius:0f,Particle:{type:"block",block_state:"minecraft:air"}}
