...
setblock -49 -28 -3 oak_wall_sign[facing=east,waterlogged=false]{front_text:{has_glowing_text:0b,color:"black",messages:[{click_event:{action:"run_command",command:"/trigger leavegame"},color:"#00CCCC",translate:"game.leave_sign.1",with:[{color:"#55FFFF",translate:"game.leave_sign.leave"}]},{color:"#00CCCC",translate:"game.leave_sign.2",with:[{color:"#55FFFF",translate:"game.leave_sign.leave"}]},{translate:"game.leave_sign.3",color:"#00CCCC",with:[{color:"#55FFFF",translate:"game.leave_sign.leave"}]},{translate:"game.leave_sign.4",color:"#00CCCC",with:[{color:"#55FFFF",translate:"game.leave_sign.leave"}]}]}}
setblock -49 -28 3 air
setblock -49 -28 3 oak_wall_sign[facing=east,waterlogged=false]{front_text:{has_glowing_text:0b,color:"black",messages:[{click_event:{action:"run_command",command:"/trigger leavegame"},color:"#00CCCC",translate:"game.leave_sign.1",with:[{color:"#55FFFF",translate:"game.leave_sign.leave"}]},{color:"#00CCCC",translate:"game.leave_sign.2",with:[{color:"#55FFFF",translate:"game.leave_sign.leave"}]},{translate:"game.leave_sign.3",color:"#00CCCC",with:[{color:"#55FFFF",translate:"game.leave_sign.leave"}]},{translate:"game.leave_sign.4",color:"#00CCCC",with:[{color:"#55FFFF",translate:"game.leave_sign.leave"}]}]}}
