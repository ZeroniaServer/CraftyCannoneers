...
kill @e[type=item_display,tag=GasBubble,predicate=!cannons:ships/tutorial]
kill @e[type=item_display,tag=gascloud,predicate=!cannons:ships/tutorial]
kill @e[type=marker,tag=GasCloud,predicate=!cannons:ships/tutorial]
