...
execute if entity @s[type=interaction,tag=cannon] run attribute @a[tag=raycaster,limit=1] generic.attack_damage modifier add craftycannoneers:nodamage -100 add_value