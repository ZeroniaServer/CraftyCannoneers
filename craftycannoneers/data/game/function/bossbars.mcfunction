...
bossbar set purpleship name ["",{translate:"%1$s (%2$s): ",with:[{translate:"game.ship_health.purple"},{translate:"game.you"}],color:"dark_purple"},{text:"❤",color:"red"},{"score":{"name":"$PurpleHP","objective":"CmdData"},color:"gray"},"/",{"score":{"name":"$ShipHP","objective":"CmdData"},color:"gray"},{text:" | ",color:"dark_gray",bold:true},{translate:"%1$s: ",with:[{translate:"game.ship_health.orange"}],color:"gold"},{text:"❤",color:"red"},{"score":{"name":"$OrangeHP","objective":"CmdData"},color:"gray"},"/",{"score":{"name":"$ShipHP","objective":"CmdData"},color:"gray"}]
bossbar set orangeship2 name ["",{translate:"%1$s (%2$s): ",with:[{translate:"game.ship_health.orange"},{translate:"game.you"}],color:"gold"},{text:"❤",color:"red"},{"score":{"name":"$OrangeHP","objective":"CmdData"},color:"gray"},"/",{"score":{"name":"$ShipHP","objective":"CmdData"},color:"gray"},{text:" | ",color:"dark_gray",bold:true},{translate:"%1$s: ",with:[{translate:"game.ship_health.purple"}],color:"dark_purple"},{text:"❤",color:"red"},{"score":{"name":"$PurpleHP","objective":"CmdData"},color:"gray"},"/",{"score":{"name":"$ShipHP","objective":"CmdData"},color:"gray"}]
bossbar set purpleship3 name ["",{translate:"%1$s: ",with:[{translate:"game.ship_health.purple"}],color:"dark_purple"},{text:"❤",color:"red"},{"score":{"name":"$PurpleHP","objective":"CmdData"},color:"gray"},"/",{"score":{"name":"$ShipHP","objective":"CmdData"},color:"gray"},{text:" | ",color:"dark_gray",bold:true},{translate:"%1$s: ",with:[{translate:"game.ship_health.orange"}],color:"gold"},{text:"❤",color:"red"},{"score":{"name":"$OrangeHP","objective":"CmdData"},color:"gray"},"/",{"score":{"name":"$ShipHP","objective":"CmdData"},color:"gray"}]
