...
execute if score @s crabmode matches 0..50 on vehicle on controller run attribute @s minecraft:follow_range base set 0
...
execute if score @s crabmode matches 51..75 on vehicle if entity @s[tag=!inwater] on controller run attribute @s minecraft:follow_range base set 32
execute if score @s crabmode matches 51..75 on vehicle if entity @s[tag=inwater] on passengers on passengers run attribute @s[type=endermite] minecraft:follow_range base set 32
...
execute if score @s crabmode matches 76.. on vehicle if entity @s[tag=!inwater] on controller if entity @a[team=!Spectator,distance=..15] run attribute @s minecraft:follow_range base set 16
execute if score @s crabmode matches 76.. on vehicle if entity @s[tag=inwater] on passengers on passengers if entity @a[team=!Spectator,distance=..15] run attribute @s[type=endermite] minecraft:follow_range base set 16