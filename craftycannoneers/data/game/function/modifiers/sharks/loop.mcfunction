...
execute as @a[team=!Lobby,team=!Spectator,gamemode=adventure,predicate=game:inwater,predicate=game:orangeside] unless score @s respawn matches 1.. run tag @s add SharkTarget
execute as @a[team=!Lobby,team=!Spectator,gamemode=adventure,predicate=game:inwater,predicate=game:purpleside] unless score @s respawn matches 1.. run tag @s add SharkTarget
