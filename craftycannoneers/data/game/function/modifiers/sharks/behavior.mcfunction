...
execute if score $Storms CmdData matches 1 if entity @s[tag=Pos1,tag=OnCooldown] unless entity @e[type=cod,tag=Pos1,tag=NewVCod] at @s run summon cod ~ ~ ~ {PersistenceRequired:1b,Silent:1b,attributes:[{base:0.6d,id:"minecraft:movement_speed"}],Tags:["Pos1","SharkCod","SharkEntity","NewVCod"],Invulnerable:1b,DeathTime:17s,DeathLootTable:"minecraft:empty"}
execute if score $Storms CmdData matches 1 if entity @s[tag=Pos2,tag=OnCooldown] unless entity @e[type=cod,tag=Pos2,tag=NewVCod] at @s run summon cod ~ ~ ~ {PersistenceRequired:1b,Silent:1b,attributes:[{base:0.6d,id:"minecraft:movement_speed"}],Tags:["Pos2","SharkCod","SharkEntity","NewVCod"],Invulnerable:1b,DeathTime:17s,DeathLootTable:"minecraft:empty"}
execute if score $Storms CmdData matches 1 if entity @s[tag=Pos3,tag=OnCooldown] unless entity @e[type=cod,tag=Pos3,tag=NewVCod] at @s run summon cod ~ ~ ~ {PersistenceRequired:1b,Silent:1b,attributes:[{base:0.6d,id:"minecraft:movement_speed"}],Tags:["Pos3","SharkCod","SharkEntity","NewVCod"],Invulnerable:1b,DeathTime:17s,DeathLootTable:"minecraft:empty"}
execute if score $Storms CmdData matches 1 if entity @s[tag=Pos4,tag=OnCooldown] unless entity @e[type=cod,tag=Pos4,tag=NewVCod] at @s run summon cod ~ ~ ~ {PersistenceRequired:1b,Silent:1b,attributes:[{base:0.6d,id:"minecraft:movement_speed"}],Tags:["Pos4","SharkCod","SharkEntity","NewVCod"],Invulnerable:1b,DeathTime:17s,DeathLootTable:"minecraft:empty"}
execute if score $Storms CmdData matches 1 if entity @s[tag=Pos5,tag=OnCooldown] unless entity @e[type=cod,tag=Pos5,tag=NewVCod] at @s run summon cod ~ ~ ~ {PersistenceRequired:1b,Silent:1b,attributes:[{base:0.6d,id:"minecraft:movement_speed"}],Tags:["Pos5","SharkCod","SharkEntity","NewVCod"],Invulnerable:1b,DeathTime:17s,DeathLootTable:"minecraft:empty"}
...
execute if entity @s[tag=Pos1,tag=SwimBack,tag=!OnCooldown] run rotate @s facing 57 -33 34
execute if entity @s[tag=Pos2,tag=SwimBack,tag=!OnCooldown] run rotate @s facing 68 -33 34
execute if entity @s[tag=Pos3,tag=SwimBack,tag=!OnCooldown] run rotate @s facing 79 -33 34
execute if entity @s[tag=Pos4,tag=SwimBack,tag=!OnCooldown] run rotate @s facing 83 -33 -34
execute if entity @s[tag=Pos5,tag=SwimBack,tag=!OnCooldown] run rotate @s facing 72 -33 -34
execute if entity @s[tag=Pos6,tag=SwimBack,tag=!OnCooldown] run rotate @s facing 61 -33 -34
...
execute if score @s sharkcooldown matches 1.. run attribute @s follow_range base set 0
execute unless score @s sharkcooldown matches 1.. run attribute @s follow_range base set 15
