execute as @a[team=!Lobby,team=!Spectator,limit=1,sort=random,predicate=cannons:safezones/island,predicate=!game:inwater,predicate=game:onground] at @s run summon leash_knot ~ ~ ~ {Tags:["StormEntity","LightningPlacer"]}
