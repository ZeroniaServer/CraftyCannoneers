...
execute if score $WindEffect CmdData matches 20.. as @e[type=splash_potion,tag=Bomb,predicate=!cannons:safezones/tutorial,predicate=!game:inwater] run function game:modifiers/seastorms/projectileinacc
