...
#> When youre on land, in a boat, or climbing out of water, replace all active and inactive harpoons with normal (no riptide and full durability)
execute if entity @s[predicate=game:onground,predicate=!game:inwater] run scoreboard players set $harpoon CmdData 0
...
#> When youre in water and not in a boat, replace all normal harpoons with active (has riptide and full durability)
...
#> When youve used an active harpoon, replace it with an inactive harpoon (no riptide and no durability)
