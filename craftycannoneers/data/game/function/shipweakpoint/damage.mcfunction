...
execute at @s[tag=Purple] positioned ~ ~ ~2 if entity @e[type=marker,tag=ImpactMarker,tag=Hit1,distance=..3] run tag @s add respawn
execute at @s[tag=Purple] positioned ~ ~ ~3 if entity @e[type=marker,tag=ImpactMarker,tag=!Hit,distance=..3] run tag @s add respawn
execute at @s[tag=Orange] positioned ~ ~ ~-2 if entity @e[type=marker,tag=ImpactMarker,tag=Hit1,distance=..3] run tag @s add respawn
execute at @s[tag=Orange] positioned ~ ~ ~-3 if entity @e[type=marker,tag=ImpactMarker,tag=!Hit1,distance=..3] run tag @s add respawn
