...
#> Boat
execute as @e[type=oak_boat,tag=BoatBoat] at @s run function game:boat/boat

#> Temporary light
execute as @e[type=marker,tag=templight] at @s run function game:boat/cannon/templight

#> Respawning (failsafe)
execute if entity @a unless entity @e[type=oak_boat,tag=BoatBoat,tag=1] run summon marker 109 -31 0 {Tags:["1","respawnboat"],Rotation:[0.0f,0.0f]}
execute if entity @a unless entity @e[type=oak_boat,tag=BoatBoat,tag=2] run summon marker 31 -31 0 {Tags:["2","respawnboat"],Rotation:[-180.0f,0.0f]}
execute if entity @a unless entity @e[type=oak_boat,tag=BoatBoat,tag=3] run summon marker 83 -31 12 {Tags:["3","respawnboat"],Rotation:[0.0f,0.0f]}
execute if entity @a unless entity @e[type=oak_boat,tag=BoatBoat,tag=4] run summon marker 57 -31 -12 {Tags:["4","respawnboat"],Rotation:[-180.0f,0.0f]}
...
execute if score $BoatCannons CmdData matches 1 as @e[type=villager,tag=BoatCannonAnchor,predicate=!game:boat/inboat] run function game:boat/cannon/kill
