...
execute if entity @s[tag=1] run tag @e[type=oak_boat,tag=Rotate,limit=1] add 1
execute if entity @s[tag=2] run tag @e[type=oak_boat,tag=Rotate,limit=1] add 2
execute if entity @s[tag=3] run tag @e[type=oak_boat,tag=Rotate,limit=1] add 3
execute if entity @s[tag=4] run tag @e[type=oak_boat,tag=Rotate,limit=1] add 4

execute if entity @s[tag=1] store result score $boat1 CmdData run data get entity @e[type=oak_boat,tag=Rotate,limit=1] UUID[0]
execute if entity @s[tag=2] store result score $boat2 CmdData run data get entity @e[type=oak_boat,tag=Rotate,limit=1] UUID[0]
execute if entity @s[tag=3] store result score $boat3 CmdData run data get entity @e[type=oak_boat,tag=Rotate,limit=1] UUID[0]
execute if entity @s[tag=4] store result score $boat4 CmdData run data get entity @e[type=oak_boat,tag=Rotate,limit=1] UUID[0]
...
execute if score $BoatCannons CmdData matches 1 as @e[type=oak_boat,tag=Rotate,limit=1] run function game:boat/transfer

execute if entity @s[tag=respawnboat] as @e[type=oak_boat,tag=Rotate,limit=1] at @s run function game:boat/anchor

tag @e[type=oak_boat,tag=Rotate,limit=1] remove Rotate