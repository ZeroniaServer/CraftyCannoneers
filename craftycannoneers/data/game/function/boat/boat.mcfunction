...
execute at @s[tag=1,tag=!Sinking] if entity @a[team=!Lobby,team=!Spectator,team=!Developer,predicate=game:boat/motionlock/inboat1,limit=1] run tag @s add Sailing
execute at @s[tag=2,tag=!Sinking] if entity @a[team=!Lobby,team=!Spectator,team=!Developer,predicate=game:boat/motionlock/inboat2,limit=1] run tag @s add Sailing
execute at @s[tag=3,tag=!Sinking] if entity @a[team=!Lobby,team=!Spectator,team=!Developer,predicate=game:boat/motionlock/inboat3,limit=1] run tag @s add Sailing
execute at @s[tag=4,tag=!Sinking] if entity @a[team=!Lobby,team=!Spectator,team=!Developer,predicate=game:boat/motionlock/inboat4,limit=1] run tag @s add Sailing
...
execute if entity @s[tag=!Sinking,predicate=cannons:ships/orange,predicate=cannons:ships/underbottom,predicate=!game:instillwater,predicate=!game:onground] align y run tp @s ~ ~1 ~
execute if entity @s[tag=!Sinking,predicate=cannons:ships/purple,predicate=cannons:ships/underbottom,predicate=!game:instillwater,predicate=!game:onground] align y run tp @s ~ ~1 ~
