...
execute if score $rightdir CmdData matches 1 on passengers run attribute @s[type=player,tag=!lookAtBCannon] attack_damage modifier add craftycannoneers:nodamage -100 add_value
