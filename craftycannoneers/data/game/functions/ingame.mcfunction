...
execute if entity @e[type=slime,tag=Weakpoint,tag=Orange,tag=WeakpointDamaged] if entity @e[type=marker,tag=WeakpointLoc,tag=Orange] run function game:shipweakpoint/spawnnewpurple
execute if entity @e[type=slime,tag=Weakpoint,tag=Purple,tag=WeakpointDamaged] if entity @e[type=marker,tag=WeakpointLoc,tag=Purple] run function game:shipweakpoint/spawnneworange
