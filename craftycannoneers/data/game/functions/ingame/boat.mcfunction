...
execute as @e[tag=BoatBoat,tag=!Sinking,tag=Sailing,tag=1] at @s unless entity @a[nbt={RootVehicle:{}},distance=..1] run summon boat ~ ~0.2 ~ {Invulnerable:1b,Tags:["Boat","BoatBoat","1"],Passengers:[{id:"minecraft:armor_stand",Tags:["Boat","BoatAS","New"],Marker:1b,Invulnerable:1b,NoGravity:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:black_banner",Count:1b,tag:{BlockEntityTag:{Patterns:[{Pattern:sku,Color:0}]}}}]},{}]}
execute as @e[tag=BoatBoat,tag=!Sinking,tag=Sailing,tag=2] at @s unless entity @a[nbt={RootVehicle:{}},distance=..1] run summon boat ~ ~0.2 ~ {Invulnerable:1b,Rotation:[180.0f,0.0f],Tags:["Boat","BoatBoat","2"],Passengers:[{id:"minecraft:armor_stand",Tags:["Boat","BoatAS","New"],Marker:1b,Invulnerable:1b,NoGravity:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:black_banner",Count:1b,tag:{BlockEntityTag:{Patterns:[{Pattern:sku,Color:0}]}}}]},{}]}
execute as @e[tag=BoatBoat,tag=!Sinking,tag=Sailing,tag=3] at @s unless entity @a[nbt={RootVehicle:{}},distance=..1] run summon boat ~ ~0.2 ~ {Invulnerable:1b,Tags:["Boat","BoatBoat","3"],Passengers:[{id:"minecraft:armor_stand",Tags:["Boat","BoatAS","New"],Marker:1b,Invulnerable:1b,NoGravity:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:black_banner",Count:1b,tag:{BlockEntityTag:{Patterns:[{Pattern:sku,Color:0}]}}}]},{}]}
execute as @e[tag=BoatBoat,tag=!Sinking,tag=Sailing,tag=4] at @s unless entity @a[nbt={RootVehicle:{}},distance=..1] run summon boat ~ ~0.2 ~ {Invulnerable:1b,Rotation:[180.0f,0.0f],Tags:["Boat","BoatBoat","4"],Passengers:[{id:"minecraft:armor_stand",Tags:["Boat","BoatAS","New"],Marker:1b,Invulnerable:1b,NoGravity:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:black_banner",Count:1b,tag:{BlockEntityTag:{Patterns:[{Pattern:sku,Color:0}]}}}]},{}]}
execute as @e[tag=BoatBoat,tag=!Sinking,tag=Sailing] at @s unless entity @a[nbt={RootVehicle:{}},distance=..1] run kill @e[tag=BoatAS,limit=1,sort=nearest,distance=..3,tag=!New]
