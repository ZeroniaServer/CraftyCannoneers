...
execute as @e[tag=BoatBoat,tag=!Sinking] at @s if entity @a[nbt={RootVehicle:{}},distance=..1.5] run tag @s add Sailing
execute as @e[tag=BoatAS] at @s if entity @a[team=Purple,nbt={RootVehicle:{}},distance=..1.5] run item replace entity @s armor.head with purple_banner{BlockEntityTag:{Patterns:[{Pattern:mc,Color:15},{Pattern:rs,Color:10},{Pattern:ls,Color:10},{Pattern:ts,Color:10},{Pattern:hhb,Color:10},{Pattern:sku,Color:0}]}}
execute as @e[tag=BoatAS] at @s if entity @a[team=Orange,nbt={RootVehicle:{}},distance=..1.5] run item replace entity @s armor.head with orange_banner{BlockEntityTag:{Patterns:[{Pattern:mc,Color:15},{Pattern:rs,Color:1},{Pattern:ls,Color:1},{Pattern:hhb,Color:1},{Pattern:ts,Color:1},{Pattern:sku,Color:0}]}}

execute as @e[tag=BoatBoat,tag=!Sinking,tag=Sailing3,tag=1] at @s unless entity @a[nbt={RootVehicle:{}},distance=..1.5] run summon boat ~ ~0.2 ~ {Invulnerable:1b,Tags:["Boat","BoatBoat","1"],Passengers:[{id:"minecraft:armor_stand",Tags:["Boat","BoatAS","New"],Marker:1b,Invulnerable:1b,NoGravity:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:black_banner",Count:1b,tag:{BlockEntityTag:{Patterns:[{Pattern:sku,Color:0}]}}}]},{}]}
execute as @e[tag=BoatBoat,tag=!Sinking,tag=Sailing3,tag=2] at @s unless entity @a[nbt={RootVehicle:{}},distance=..1.5] run summon boat ~ ~0.2 ~ {Invulnerable:1b,Rotation:[180.0f,0.0f],Tags:["Boat","BoatBoat","2"],Passengers:[{id:"minecraft:armor_stand",Tags:["Boat","BoatAS","New"],Marker:1b,Invulnerable:1b,NoGravity:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:black_banner",Count:1b,tag:{BlockEntityTag:{Patterns:[{Pattern:sku,Color:0}]}}}]},{}]}
execute as @e[tag=BoatBoat,tag=!Sinking,tag=Sailing3,tag=3] at @s unless entity @a[nbt={RootVehicle:{}},distance=..1.5] run summon boat ~ ~0.2 ~ {Invulnerable:1b,Tags:["Boat","BoatBoat","3"],Passengers:[{id:"minecraft:armor_stand",Tags:["Boat","BoatAS","New"],Marker:1b,Invulnerable:1b,NoGravity:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:black_banner",Count:1b,tag:{BlockEntityTag:{Patterns:[{Pattern:sku,Color:0}]}}}]},{}]}
execute as @e[tag=BoatBoat,tag=!Sinking,tag=Sailing3,tag=4] at @s unless entity @a[nbt={RootVehicle:{}},distance=..1.5] run summon boat ~ ~0.2 ~ {Invulnerable:1b,Rotation:[180.0f,0.0f],Tags:["Boat","BoatBoat","4"],Passengers:[{id:"minecraft:armor_stand",Tags:["Boat","BoatAS","New"],Marker:1b,Invulnerable:1b,NoGravity:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:black_banner",Count:1b,tag:{BlockEntityTag:{Patterns:[{Pattern:sku,Color:0}]}}}]},{}]}
execute as @e[tag=BoatBoat,tag=!Sinking,tag=Sailing3] at @s unless entity @a[nbt={RootVehicle:{}},distance=..1.5] run kill @e[tag=BoatAS,limit=1,sort=nearest,distance=..3,tag=!New]
execute as @e[tag=BoatBoat,tag=!Sinking,tag=Sailing3] at @s unless entity @a[nbt={RootVehicle:{}},distance=..1.5] run kill @s

tag @e[tag=BoatAS,tag=New] remove New

tag @e[tag=Sailing2] add Sailing3
tag @e[tag=Sailing1] add Sailing2
tag @e[tag=Sailing] add Sailing1
