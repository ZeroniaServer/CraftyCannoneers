...
execute unless score @s openchest matches 1.. unless score @s spotting matches 1.. unless block ~ ~-1 ~ air unless block ~ ~-1 ~ water run title @s[team=Orange,predicate=game:onpurple,tag=!EnemyMSG,tag=!SeeWeakpoint,nbt={OnGround:1b}] subtitle {"translate":"game.boarded","color":"dark_red"}
execute unless score @s openchest matches 1.. unless score @s spotting matches 1.. unless block ~ ~-1 ~ air unless block ~ ~-1 ~ water run tag @s[team=Orange,predicate=game:onpurple,tag=!EnemyMSG,tag=!SeeWeakpoint,nbt={OnGround:1b}] add EnemyMSG
...
execute unless score @s openchest matches 1.. unless score @s spotting matches 1.. unless block ~ ~-1 ~ air unless block ~ ~-1 ~ water run title @s[team=Purple,predicate=game:onorange,tag=!EnemyMSG,tag=!SeeWeakpoint,nbt={OnGround:1b}] subtitle {"translate":"game.boarded","color":"dark_red"}
execute unless score @s openchest matches 1.. unless score @s spotting matches 1.. unless block ~ ~-1 ~ air unless block ~ ~-1 ~ water run tag @s[team=Purple,predicate=game:onorange,tag=!EnemyMSG,tag=!SeeWeakpoint,nbt={OnGround:1b}] add EnemyMSG
