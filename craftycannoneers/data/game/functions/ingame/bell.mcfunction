...
data merge entity @s[scores={CmdData=300,bellring=12}] {start_interpolation:0,interpolation_duration:1,transformation:{left_rotation:{axis:[1f,0f,0f],angle:0.05f}}}
...
data merge entity @s[scores={CmdData=302,bellring=12}] {start_interpolation:0,interpolation_duration:1,transformation:{left_rotation:{axis:[1f,0f,0f],angle:-0.05f}}}
