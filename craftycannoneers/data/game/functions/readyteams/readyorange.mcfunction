...
title @a[tag=!inParkour,team=!Spectator] actionbar ["",{"translate":"game.marked_ready","color":"aqua","with":[{"selector":"@s","bold":true},{"translate":"game.marked_ready.orange","color":"gold","bold":true},{"translate":"game.marked_ready.team","color":"aqua"},{"translate":"game.marked_ready.ready","color":"green","bold":true,"underlined":true}]}]
