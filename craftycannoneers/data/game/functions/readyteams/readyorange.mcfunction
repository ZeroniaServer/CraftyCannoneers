...
title @a[tag=!inParkour,team=!Spectator] actionbar ["",{"selector":"@s","bold":true},{"translate":"game.marked_ready.1","color":"aqua"},{"translate":"game.orange","color":"gold","bold":true},{"translate":"game.marked_ready.2","color":"aqua"},{"translate":"game.marked_ready.ready","color":"green","bold":true,"underlined":true}]
