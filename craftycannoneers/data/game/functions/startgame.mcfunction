...
execute as @a[tag=StartGame,sort=random,limit=1] if entity @a[team=Orange] if entity @a[team=Purple] run tellraw @a ["",{"selector":"@s","color":"dark_green"},{"text":" Started the game!","color":"green"}]
