...
execute if entity @s[team=Purple,scores={spotting=43..}] run title @a[team=Purple] title {"text":" ","color":"white"}
execute if entity @s[team=Purple,scores={spotting=43..}] run title @a[team=Purple] subtitle {"text":" ","color":"white"}
...
execute if entity @s[team=Orange,scores={spotting=43..}] run title @a[team=Orange] title {"text":" ","color":"white"}
execute if entity @s[team=Orange,scores={spotting=43..}] run title @a[team=Orange] subtitle {"text":" ","color":"white"}
