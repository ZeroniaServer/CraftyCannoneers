...
execute as @a[team=Purple,tag=SeeWeakpoint,scores={spotting=55},limit=1,sort=random] run execute as @a[team=Purple] at @s run playsound minecraft:block.note_block.hat master @s ~ ~ ~ 0.4 1.4
...
execute as @a[team=Orange,tag=SeeWeakpoint,scores={spotting=55},limit=1,sort=random] run execute as @a[team=Orange] at @s run playsound minecraft:block.note_block.hat master @s ~ ~ ~ 0.4 1.4
