...
execute as fffffe5c-ffff-ffbb-0000-01a400000045 on passengers if data entity @s data.Item run data modify entity @e[type=marker,tag=gravedata,tag=new,limit=1] data.Items append from entity @s data.Item
tag @s remove new
