...
#> Summon grave chest
execute at @s run summon hopper_minecart ~ ~ ~ {Tags:["grave","chest","new"],LootTable:"chests:empty",CustomDisplayTile:1b,DisplayState:{Name:"minecraft:air"},Invulnerable:1b,Silent:1b,Enabled:0b,Passengers:[{id:"minecraft:marker",Tags:["gravedata","grave","new"]}]}
data modify entity @s item_display set value "head"
item replace entity @s container.0 with diamond_hoe{CustomModelData:134}
