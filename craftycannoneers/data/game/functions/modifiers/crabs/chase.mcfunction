...
summon cat ~ ~ ~ {Tags:["CrabEntity","CrabVehicle","temp"],variant:"minecraft:calico",Age:-2147483648,Silent:1b,PersistenceRequired:1b,ActiveEffects:[{Id:14,Amplifier:0b,Duration:-1,ShowParticles:0b}]}
