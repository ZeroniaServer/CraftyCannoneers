...
summon cat ~ ~ ~ {Tags:["CrabEntity","CrabVehicle","temp"],variant:"minecraft:calico",Age:-2147483648,Silent:1b,PersistenceRequired:1b,Attributes:[{Name:"generic.max_health",Base:100}],ActiveEffects:[{Id:6,Amplifier:100b,Duration:-1,ShowParticles:0b},{Id:13,Amplifier:100b,Duration:-1,ShowParticles:0b}]}
