...
execute if score $steal CmdData matches 1 on passengers run item replace entity @a[tag=victim,limit=1] hotbar.1 with air
execute if score $steal CmdData matches 2 on passengers run item replace entity @a[tag=victim,limit=1] hotbar.2 with air
execute if score $steal CmdData matches 3 on passengers run item replace entity @a[tag=victim,limit=1] hotbar.3 with air
execute if score $steal CmdData matches 4 on passengers run item replace entity @a[tag=victim,limit=1] hotbar.4 with air
execute if score $steal CmdData matches 5 on passengers run item replace entity @a[tag=victim,limit=1] hotbar.5 with air
execute if score $steal CmdData matches 6 on passengers run item replace entity @a[tag=victim,limit=1] hotbar.6 with air
execute if score $steal CmdData matches 7 on passengers run item replace entity @a[tag=victim,limit=1] hotbar.7 with air
execute if score $steal CmdData matches 8 on passengers run item replace entity @a[tag=victim,limit=1] hotbar.8 with air
execute if score $steal CmdData matches 9 on passengers run item replace entity @a[tag=victim,limit=1] inventory.0 with air
execute if score $steal CmdData matches 10 on passengers run item replace entity @a[tag=victim,limit=1] inventory.1 with air
execute if score $steal CmdData matches 11 on passengers run item replace entity @a[tag=victim,limit=1] inventory.2 with air
execute if score $steal CmdData matches 12 on passengers run item replace entity @a[tag=victim,limit=1] inventory.3 with air
execute if score $steal CmdData matches 13 on passengers run item replace entity @a[tag=victim,limit=1] inventory.4 with air
execute if score $steal CmdData matches 14 on passengers run item replace entity @a[tag=victim,limit=1] inventory.5 with air
execute if score $steal CmdData matches 15 on passengers run item replace entity @a[tag=victim,limit=1] inventory.6 with air
execute if score $steal CmdData matches 16 on passengers run item replace entity @a[tag=victim,limit=1] inventory.7 with air
execute if score $steal CmdData matches 17 on passengers run item replace entity @a[tag=victim,limit=1] inventory.8 with air
execute if score $steal CmdData matches 18 on passengers run item replace entity @a[tag=victim,limit=1] inventory.9 with air
execute if score $steal CmdData matches 19 on passengers run item replace entity @a[tag=victim,limit=1] inventory.10 with air
execute if score $steal CmdData matches 20 on passengers run item replace entity @a[tag=victim,limit=1] inventory.11 with air
execute if score $steal CmdData matches 21 on passengers run item replace entity @a[tag=victim,limit=1] inventory.12 with air
execute if score $steal CmdData matches 22 on passengers run item replace entity @a[tag=victim,limit=1] inventory.13 with air
execute if score $steal CmdData matches 23 on passengers run item replace entity @a[tag=victim,limit=1] inventory.14 with air
execute if score $steal CmdData matches 24 on passengers run item replace entity @a[tag=victim,limit=1] inventory.15 with air
execute if score $steal CmdData matches 25 on passengers run item replace entity @a[tag=victim,limit=1] inventory.16 with air
execute if score $steal CmdData matches 26 on passengers run item replace entity @a[tag=victim,limit=1] inventory.17 with air
execute if score $steal CmdData matches 27 on passengers run item replace entity @a[tag=victim,limit=1] inventory.18 with air
execute if score $steal CmdData matches 28 on passengers run item replace entity @a[tag=victim,limit=1] inventory.19 with air
execute if score $steal CmdData matches 29 on passengers run item replace entity @a[tag=victim,limit=1] inventory.20 with air
execute if score $steal CmdData matches 30 on passengers run item replace entity @a[tag=victim,limit=1] inventory.21 with air
execute if score $steal CmdData matches 31 on passengers run item replace entity @a[tag=victim,limit=1] inventory.22 with air
execute if score $steal CmdData matches 32 on passengers run item replace entity @a[tag=victim,limit=1] inventory.23 with air
execute if score $steal CmdData matches 33 on passengers run item replace entity @a[tag=victim,limit=1] inventory.24 with air
execute if score $steal CmdData matches 34 on passengers run item replace entity @a[tag=victim,limit=1] inventory.25 with air
execute if score $steal CmdData matches 35 on passengers run item replace entity @a[tag=victim,limit=1] inventory.26 with air
execute if score $steal CmdData matches 36 on passengers run item replace entity @a[tag=victim,limit=1] weapon.offhand with air