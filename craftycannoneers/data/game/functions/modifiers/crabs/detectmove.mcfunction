...
item replace entity @s[tag=Moving] container.0 with diamond_hoe{CustomModelData:118}
item replace entity @s[tag=!Moving] container.0 with diamond_hoe{CustomModelData:117}
