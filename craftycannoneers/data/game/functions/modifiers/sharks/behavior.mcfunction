...
execute if score $Storms CmdData matches 1 if entity @s[tag=Pos1,tag=!IsBack] unless entity @a[tag=SharkTarget,team=!Lobby,team=!Spectator,distance=..12] positioned 57 -33 34 if entity @s[distance=..4] at @s run summon cod ~ ~ ~ {PersistenceRequired:1b,Silent:1b,Attributes:[{Base:0.6d,Name:"minecraft:generic.movement_speed"}],Tags:["Pos1","SharkCod","SharkEntity","NewVCod"],Invulnerable:1b,DeathTime:19s,DeathLootTable:"minecraft:empty"}
execute if score $Storms CmdData matches 1 if entity @s[tag=Pos2,tag=!IsBack] unless entity @a[tag=SharkTarget,team=!Lobby,team=!Spectator,distance=..12] positioned 68 -33 34 if entity @s[distance=..4] at @s run summon cod ~ ~ ~ {PersistenceRequired:1b,Silent:1b,Attributes:[{Base:0.6d,Name:"minecraft:generic.movement_speed"}],Tags:["Pos2","SharkCod","SharkEntity","NewVCod"],Invulnerable:1b,DeathTime:19s,DeathLootTable:"minecraft:empty"}
execute if score $Storms CmdData matches 1 if entity @s[tag=Pos3,tag=!IsBack] unless entity @a[tag=SharkTarget,team=!Lobby,team=!Spectator,distance=..12] positioned 79 -33 34 if entity @s[distance=..4] at @s run summon cod ~ ~ ~ {PersistenceRequired:1b,Silent:1b,Attributes:[{Base:0.6d,Name:"minecraft:generic.movement_speed"}],Tags:["Pos3","SharkCod","SharkEntity","NewVCod"],Invulnerable:1b,DeathTime:19s,DeathLootTable:"minecraft:empty"}
execute if score $Storms CmdData matches 1 if entity @s[tag=Pos4,tag=!IsBack] unless entity @a[tag=SharkTarget,team=!Lobby,team=!Spectator,distance=..12] positioned 83 -33 -34 if entity @s[distance=..4] at @s run summon cod ~ ~ ~ {PersistenceRequired:1b,Silent:1b,Attributes:[{Base:0.6d,Name:"minecraft:generic.movement_speed"}],Tags:["Pos4","SharkCod","SharkEntity","NewVCod"],Invulnerable:1b,DeathTime:19s,DeathLootTable:"minecraft:empty"}
execute if score $Storms CmdData matches 1 if entity @s[tag=Pos5,tag=!IsBack] unless entity @a[tag=SharkTarget,team=!Lobby,team=!Spectator,distance=..12] positioned 72 -33 -34 if entity @s[distance=..4] at @s run summon cod ~ ~ ~ {PersistenceRequired:1b,Silent:1b,Attributes:[{Base:0.6d,Name:"minecraft:generic.movement_speed"}],Tags:["Pos5","SharkCod","SharkEntity","NewVCod"],Invulnerable:1b,DeathTime:19s,DeathLootTable:"minecraft:empty"}
execute if score $Storms CmdData matches 1 if entity @s[tag=Pos6,tag=!IsBack] unless entity @a[tag=SharkTarget,team=!Lobby,team=!Spectator,distance=..12] positioned 61 -33 -34 if entity @s[distance=..4] at @s run summon cod ~ ~ ~ {PersistenceRequired:1b,Silent:1b,Attributes:[{Base:0.6d,Name:"minecraft:generic.movement_speed"}],Tags:["Pos6","SharkCod","SharkEntity","NewVCod"],Invulnerable:1b,DeathTime:19s,DeathLootTable:"minecraft:empty"}

execute if score $Storms CmdData matches 1 if entity @s[tag=Pos1,tag=!IsBack] unless entity @a[tag=SharkTarget,team=!Lobby,team=!Spectator,distance=..12] positioned 57 -33 34 if entity @s[distance=..4] at @s run summon cod ~ ~ ~ {PersistenceRequired:1b,Silent:1b,Attributes:[{Base:0.6d,Name:"minecraft:generic.movement_speed"}],Tags:["Pos1","SharkCod","SharkEntity","NewPCod"],Invulnerable:1b,DeathTime:19s,DeathLootTable:"minecraft:empty"}
execute if score $Storms CmdData matches 1 if entity @s[tag=Pos2,tag=!IsBack] unless entity @a[tag=SharkTarget,team=!Lobby,team=!Spectator,distance=..12] positioned 68 -33 34 if entity @s[distance=..4] at @s run summon cod ~ ~ ~ {PersistenceRequired:1b,Silent:1b,Attributes:[{Base:0.6d,Name:"minecraft:generic.movement_speed"}],Tags:["Pos2","SharkCod","SharkEntity","NewPCod"],Invulnerable:1b,DeathTime:19s,DeathLootTable:"minecraft:empty"}
execute if score $Storms CmdData matches 1 if entity @s[tag=Pos3,tag=!IsBack] unless entity @a[tag=SharkTarget,team=!Lobby,team=!Spectator,distance=..12] positioned 79 -33 34 if entity @s[distance=..4] at @s run summon cod ~ ~ ~ {PersistenceRequired:1b,Silent:1b,Attributes:[{Base:0.6d,Name:"minecraft:generic.movement_speed"}],Tags:["Pos3","SharkCod","SharkEntity","NewPCod"],Invulnerable:1b,DeathTime:19s,DeathLootTable:"minecraft:empty"}
execute if score $Storms CmdData matches 1 if entity @s[tag=Pos4,tag=!IsBack] unless entity @a[tag=SharkTarget,team=!Lobby,team=!Spectator,distance=..12] positioned 83 -33 -34 if entity @s[distance=..4] at @s run summon cod ~ ~ ~ {PersistenceRequired:1b,Silent:1b,Attributes:[{Base:0.6d,Name:"minecraft:generic.movement_speed"}],Tags:["Pos4","SharkCod","SharkEntity","NewPCod"],Invulnerable:1b,DeathTime:19s,DeathLootTable:"minecraft:empty"}
execute if score $Storms CmdData matches 1 if entity @s[tag=Pos5,tag=!IsBack] unless entity @a[tag=SharkTarget,team=!Lobby,team=!Spectator,distance=..12] positioned 72 -33 -34 if entity @s[distance=..4] at @s run summon cod ~ ~ ~ {PersistenceRequired:1b,Silent:1b,Attributes:[{Base:0.6d,Name:"minecraft:generic.movement_speed"}],Tags:["Pos5","SharkCod","SharkEntity","NewPCod"],Invulnerable:1b,DeathTime:19s,DeathLootTable:"minecraft:empty"}
execute if score $Storms CmdData matches 1 if entity @s[tag=Pos6,tag=!IsBack] unless entity @a[tag=SharkTarget,team=!Lobby,team=!Spectator,distance=..12] positioned 61 -33 -34 if entity @s[distance=..4] at @s run summon cod ~ ~ ~ {PersistenceRequired:1b,Silent:1b,Attributes:[{Base:0.6d,Name:"minecraft:generic.movement_speed"}],Tags:["Pos6","SharkCod","SharkEntity","NewPCod"],Invulnerable:1b,DeathTime:19s,DeathLootTable:"minecraft:empty"}
