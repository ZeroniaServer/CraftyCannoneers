execute as @a[team=!Lobby,team=!Spectator,limit=1,nbt={OnGround:1b},sort=random,predicate=cannons:safezones/island,predicate=!game:inwater] at @s run summon leash_knot ~ ~ ~ {Tags:["StormEntity","LightningPlacer"]}
