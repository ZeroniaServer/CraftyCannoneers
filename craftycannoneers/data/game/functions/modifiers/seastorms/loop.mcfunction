...
execute if score $StormTime CmdData matches 75 run summon lightning_bolt 70 -23 0
execute if score $StormTime CmdData matches 90 run summon lightning_bolt 70 -23 0
...
execute as @e[type=marker,tag=LightningMarker] at @s if block ~ 300 ~ lightning_rod run kill @s
