...
execute if score $WindEffect CmdData matches 20..200 as @e[type=potion,tag=Bomb,predicate=!cannons:safezones/tutorial] run function game:modifiers/seastorms/cannonballinacc
