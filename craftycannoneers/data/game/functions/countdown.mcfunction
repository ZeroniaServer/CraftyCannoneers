execute if score $countSec CmdData matches 1 run data merge block -44 -28 0 {is_waxed:1b,front_text:{messages:['{"translate":"game.countdown_sign.1","color":"#55FF55","bold":true}','{"translate":"game.countdown_sign.2","color":"#55FF55","bold":true}','{"translate":"game.countdown_sign.3","color":"#55FF55","bold":true}','{"translate":"game.countdown_sign.4","color":"#55FF55","bold":true}']}}
