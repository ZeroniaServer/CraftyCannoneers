...
execute if score $MVPCount CmdData matches 1 unless entity @a[tag=CannonMVP,scores={MVPcannon=1},limit=1] run tellraw @a ["",{"selector":"@a[tag=CannonMVP,limit=1]"},{"translate":"mvp.cannon.1","color":"aqua"},{"score":{"name":"@a[tag=CannonMVP,limit=1]","objective":"MVPdamage"},"bold":true,"color":"dark_aqua"},{"translate":"mvp.cannon.damage","color":"aqua"},{"score":{"name":"@a[tag=CannonMVP,limit=1]","objective":"MVPcannon"},"bold":true,"color":"dark_aqua"},{"translate":"mvp.cannon.plural","color":"aqua"}]
