...
execute if score $MVPCount CmdData matches 1 if entity @a[tag=DeathMVP,scores={MVPdeath=1}] run tellraw @a ["",{"selector":"@a[tag=DeathMVP,limit=1,sort=random]"},{"text":" visited Davy Jones' Locker! ","color":"aqua"},{"score":{"name":"@a[tag=DeathMVP,limit=1,sort=random]","objective":"MVPdeath"},"bold":true,"color":"dark_aqua"},{"text":" pathetic death!","color":"aqua"}]
execute if score $MVPCount CmdData matches 2.. if entity @a[tag=DeathMVP,scores={MVPdeath=1}] run tellraw @a ["",{"selector":"@a[tag=DeathMVP]"},{"text":" visited Davy Jones' Locker! ","color":"aqua"},{"score":{"name":"@a[tag=DeathMVP,limit=1,sort=random]","objective":"MVPdeath"},"bold":true,"color":"dark_aqua"},{"text":" pathetic death each!","color":"aqua"}]
execute if score $MVPCount CmdData matches 1 unless entity @a[tag=DeathMVP,scores={MVPdeath=1}] run tellraw @a ["",{"selector":"@a[tag=DeathMVP,limit=1,sort=random]"},{"text":" visited Davy Jones' Locker! ","color":"aqua"},{"score":{"name":"@a[tag=DeathMVP,limit=1,sort=random]","objective":"MVPdeath"},"bold":true,"color":"dark_aqua"},{"text":" pathetic deaths!","color":"aqua"}]
execute if score $MVPCount CmdData matches 2.. unless entity @a[tag=DeathMVP,scores={MVPdeath=1}] run tellraw @a ["",{"selector":"@a[tag=DeathMVP]"},{"text":" visited Davy Jones' Locker! ","color":"aqua"},{"score":{"name":"@a[tag=DeathMVP,limit=1,sort=random]","objective":"MVPdeath"},"bold":true,"color":"dark_aqua"},{"text":" pathetic deaths each!","color":"aqua"}]
