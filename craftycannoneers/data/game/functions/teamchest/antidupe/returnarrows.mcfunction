...
execute unless score @s hasArrows > @s arrowsToShoot if score $arrct CmdData matches 0 run data modify storage craftycannoneers:chest Items[-1].id set value "air"
