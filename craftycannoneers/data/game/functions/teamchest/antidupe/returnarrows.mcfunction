...
# super cringe but mc no longer automatically removes items with count:0 from inventories, so we have to do it ourselves
...
# also if we set the ID to air then it complains in server logs
