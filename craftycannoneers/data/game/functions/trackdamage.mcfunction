...
execute if score $DamagePurple CmdData matches ..0 if score $CritPurple CmdData matches 2.. run scoreboard players set $CritPurple CmdData 1
...
execute if score $DamageOrange CmdData matches ..0 if score $CritOrange CmdData matches 2.. run scoreboard players set $CritOrange CmdData 1
