...
execute if entity @s[type=interaction,tag=cannon] run attribute @a[tag=raycaster,limit=1] generic.attack_damage modifier add 9c55d773-f866-4def-9740-6253d5ebb737 "nodamage" -100 add