...
$execute as @e[type=boat,tag=new,limit=1] at @s anchored feet rotated ~ 0 run summon camel ^ ^0.1875 ^-0.4 {Age:-2147483648,Silent:1b,DeathTime:17s,active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:-1,show_particles:0b},{id:"minecraft:instant_health",amplifier:10b,duration:-1,show_particles:0b}],Team:"NoName",PersistenceRequired:1b,NoAI:1b,Rotation:[$(angle),0.0f],Tags:["BoatCannonAnchor","new"]}
