...
execute if entity @s[tag=FireCannon] on passengers on passengers on passengers run item replace entity @s[tag=BoatCannonDisplay] container.0 with mooshroom_spawn_egg{CustomModelData:12}