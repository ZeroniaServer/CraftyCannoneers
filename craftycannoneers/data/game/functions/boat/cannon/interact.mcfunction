...
execute on vehicle run tag @s[scores={CannonID=1..}] add FireCannon
execute on vehicle run scoreboard players operation @s[tag=FireCannon] playerUUID = $temp playerUUID
