...
#> Respawning (failsafe)
execute if entity @a unless entity @e[type=boat,tag=BoatBoat,tag=1] run summon marker 109 -30 0 {Tags:["1","respawnboat"],Rotation:[0.0f,0.0f]}
execute if entity @a unless entity @e[type=boat,tag=BoatBoat,tag=2] run summon marker 31 -30 0 {Tags:["2","respawnboat"],Rotation:[-180.0f,0.0f]}
execute if entity @a unless entity @e[type=boat,tag=BoatBoat,tag=3] run summon marker 83 -30 12 {Tags:["3","respawnboat"],Rotation:[0.0f,0.0f]}
execute if entity @a unless entity @e[type=boat,tag=BoatBoat,tag=4] run summon marker 57 -30 -12 {Tags:["4","respawnboat"],Rotation:[-180.0f,0.0f]}
