...
execute if score $BoatCannons CmdData matches 1 at @e[type=interaction,tag=new,limit=1] run summon item_display ~ ~0.75 ~ {Rotation:[-104.0f,0.0f],Tags:["BoatCannonDisplay","new"]}
