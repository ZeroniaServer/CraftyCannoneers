...
execute if score $BoatCannons CmdData matches 1 as @e[type=villager,tag=new] at @s run summon item_display ~ ~0.73125 ~ {Rotation:[22.0f,0.0f],Tags:["BoatCannonDisplay","new"]}
