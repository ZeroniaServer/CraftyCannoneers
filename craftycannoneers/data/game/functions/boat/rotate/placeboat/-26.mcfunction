...
execute if score $BoatCannons CmdData matches 1 at @e[type=area_effect_cloud,tag=base,tag=new,limit=1] run summon item_display ~ ~0.75 ~ {Rotation:[-52.0f,0.0f],Tags:["BoatCannonDisplay","new"]}
