for i in range(-90,90):
    ...
    g.write("summon husk ~ ~0.73125 ~ {Silent:1b,Invulnerable:1b,DeathTime:17s,DeathLootTable:\"minecraft:empty\",PersistenceRequired:1b,NoAI:1b,CanPickUpLoot:0b,IsBaby:1b,Attributes:[{Name:\"generic.follow_range\",Base:0},{Name:\"generic.attack_damage\",Base:0}],Rotation:[%d.0f,0.0f],Team:\"NoName\",Tags:[\"BoatCannonDisplay\",\"new\"],ActiveEffects:[{Id:14,Amplifier:1b,Duration:-1,ShowParticles:0b}]}\n" % (i*2))
