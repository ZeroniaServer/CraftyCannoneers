#> Fire Cannonball
#Normal Cannonball
execute if score @s CannonID matches 1 run summon armor_stand ~ ~ ~ {Tags:["cannonball","Cannonball","NewCannonball","Hit1","boatlaunch"],Rotation:[14.0f,0.0f],Small:1b,Silent:1b,Invisible:1b,Invulnerable:1b,DisabledSlots:4144959}

#Hot Cannonball
execute if score @s CannonID matches 2 run summon armor_stand ~ ~ ~ {Tags:["cannonball","HotCannonball","NewCannonball","Hit1","boatlaunch"],Rotation:[14.0f,0.0f],Small:1b,Silent:1b,Invisible:1b,Invulnerable:1b,DisabledSlots:4144959}

#Cannonball Cluster
execute if score @s CannonID matches 3 run summon armor_stand ~ ~ ~ {Tags:["cannonball","CannonballCluster","0","NewCannonball","Hit1","boatlaunch"],Rotation:[14.0f,0.0f],Small:1b,Silent:1b,Invisible:1b,Invulnerable:1b,DisabledSlots:4144959}
...
#Chain Cannonball
execute if score @s CannonID matches 5 run summon armor_stand ~ ~ ~ {Tags:["cannonball","ChainCannonball","NewCannonball","Hit1","boatlaunch"],Rotation:[14.0f,0.0f],Small:1b,Silent:1b,Invisible:1b,Invulnerable:1b,DisabledSlots:4144959,Passengers:[{id:"minecraft:armor_stand",Invisible:1b,Marker:1b,Small:1b,Tags:["ChainAnchor"]}]}
...
#Golden Cannonball
execute if score @s CannonID matches 9 run summon armor_stand ~ ~ ~ {Tags:["cannonball","GoldenCannonball","NewCannonball","Hit1","boatlaunch"],Rotation:[14.0f,0.0f],Small:1b,Silent:1b,Invisible:1b,Invulnerable:1b,DisabledSlots:4144959}
