for i in range(-90,90):
    ...
    g.write("execute if score @s CannonID matches 3 run summon armor_stand ~ ~ ~ {Tags:[\"cannonball\",\"CannonballCluster\",\"4\",\"Hit1\",\"HRight\",\"CSpread\",\"NewCannonball\",\"boatlaunch\"],Rotation:[%d.0f,0.0f],Small:1b,Silent:1b,Invisible:1b,Invulnerable:1b,DisabledSlots:4144959}\n\n" % (i*2))
    ...
    g.write("execute if score @s CannonID matches 7 run summon armor_stand ~ ~1 ~ {Tags:[\"cannonball\",\"PlayerCannonball\",\"NewCannonball\",\"boatlaunch\"],Rotation:[%d.0f,0.0f],Small:1b,Silent:1b,Invisible:1b,Invulnerable:1b,DisabledSlots:4144959,Passengers:[{id:\"minecraft:item_display\",Tags:[\"PCannonballhat\",\"New\"],Rotation:[%d.0f,0.0f],item_display:\"head\",width:1.0f,height:1.0f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],scale:[0.4875f,0.4875f,0.4875f],translation:[0.0f,0.9575f,-0.01f]}},{id:\"minecraft:armor_stand\",Tags:[\"PCannonballdeco\",\"New\"],Rotation:[%d.0f,0.0f],Marker:1b,Invulnerable:1b,DisabledSlots:4144959,Small:1b,NoGravity:1b,Passengers:[{id:\"minecraft:slime\",Silent:1b,DeathTime:17s,DeathLootTable:\"minecraft:empty\",Invulnerable:1b,NoAI:1b,Size:1,Rotation:[%d.0f,0.0f],Tags:[\"PCannonballname\"]},{id:\"minecraft:camel\",Age:-2147483648,Silent:1b,DeathTime:17s,DeathLootTable:\"minecraft:empty\",Invulnerable:1b,NoAI:1b,Rotation:[%d.0f,0.0f],Tags:[\"PCannonballname\"],Passengers:[{id:\"minecraft:item_display\",Tags:[\"PCannonballSpec\"],Rotation:[%d.0f,0.0f]}]}]}]}\n\n" % (i*2, i*2, i*2, i*2, i*2, i*2))
