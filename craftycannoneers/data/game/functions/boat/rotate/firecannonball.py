for i in range(-90,90):
    ...
    g.write("execute if score @s CannonID matches 10 run summon armor_stand ^ ^1 ^1 {Tags:[\"cannonball\",\"CopperCannonball\",\"NewCannonball\",\"Hit1\"],Rotation:[%d.0f,0.0f],Small:1b,Silent:1b,Invisible:1b,Invulnerable:1b,DisabledSlots:4144959}" % (i*2))