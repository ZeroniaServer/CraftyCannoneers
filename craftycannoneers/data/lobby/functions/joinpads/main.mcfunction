...
execute if score $gamestate CmdData matches 0 unless entity @a[team=Purple] unless entity @a[team=Orange] run bossbar set lobbybar name ["",{"translate":"game.awaiting.and","color":"aqua","with":[{"translate":"game.purple","bold":true,"color":"dark_purple"},{"translate":"game.orange","bold":true,"color":"gold"}]}]
...
execute if score $gamestate CmdData matches 0 if entity @a[team=Purple] unless entity @a[team=Orange] run bossbar set lobbybar name ["",{"translate":"game.awaiting","color":"aqua","with":[{"translate":"game.orange","bold":true,"color":"gold"}]}]
...
execute if score $gamestate CmdData matches 0 unless entity @a[team=Purple] if entity @a[team=Orange] run bossbar set lobbybar name ["",{"translate":"game.awaiting","color":"aqua","with":[{"translate":"game.purple","bold":true,"color":"dark_purple"}]}]
