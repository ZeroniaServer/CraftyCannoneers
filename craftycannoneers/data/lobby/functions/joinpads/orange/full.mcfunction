...
execute unless score @s joinorange matches 1.. unless score $InPurple CmdData >= $MaxTeamSize CmdData run title @s subtitle ["",{"translate":"game.try_join","color":"dark_aqua","bold":false,"with":[{"translate":"game.purple","color":"dark_purple","bold":true},{"translate":"game.team","color":"dark_aqua","bold":false}]}]
...
execute if score @s joinorange matches 1.. unless score $InPurple CmdData >= $MaxTeamSize CmdData run tellraw @s ["",{"translate":"game.try_join","color":"dark_aqua","italic":true,"with":[{"translate":"game.purple","color":"dark_purple","bold":true,"italic":true},{"translate":"game.team","color":"dark_aqua","italic":true}]}]
