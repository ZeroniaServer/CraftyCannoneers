...
execute if entity @s[tag=templeader,scores={parkourSecs=..9,parkourMins=..9}] run data modify block -74 -24 1 Text2 set value '["",{"text":"0","color":"green"},{"score":{"name":"@p[tag=templeader]","objective":"parkourMins"},"color":"green"},{"text":":0","color":"green"},{"score":{"name":"@p[tag=templeader]","objective":"parkourSecs"},"color":"green"},{"text":".","color":"green"},{"score":{"name":"@p[tag=templeader]","objective":"parkourDeci"},"color":"green"},{"score":{"name":"@p[tag=templeader]","objective":"parkourDeci2"},"color":"green"}]'
execute if entity @s[tag=templeader,scores={parkourSecs=10..,parkourMins=..9}] run data modify block -74 -24 1 Text2 set value '["",{"text":"0","color":"green"},{"score":{"name":"@p[tag=templeader]","objective":"parkourMins"},"color":"green"},{"text":":","color":"green"},{"score":{"name":"@p[tag=templeader]","objective":"parkourSecs"},"color":"green"},{"text":".","color":"green"},{"score":{"name":"@p[tag=templeader]","objective":"parkourDeci"},"color":"green"},{"score":{"name":"@p[tag=templeader]","objective":"parkourDeci2"},"color":"green"}]'
execute if entity @s[tag=templeader,scores={parkourSecs=..9,parkourMins=10..}] run data modify block -74 -24 1 Text2 set value '["",{"score":{"name":"@p[tag=templeader]","objective":"parkourMins"},"color":"green"},{"text":":0","color":"green"},{"score":{"name":"@p[tag=templeader]","objective":"parkourSecs"},"color":"green"},{"text":".","color":"green"},{"score":{"name":"@p[tag=templeader]","objective":"parkourDeci"},"color":"green"},{"score":{"name":"@p[tag=templeader]","objective":"parkourDeci2"},"color":"green"}]'
execute if entity @s[tag=templeader,scores={parkourSecs=10..,parkourMins=10..}] run data modify block -74 -24 1 Text2 set value '["",{"score":{"name":"@p[tag=templeader]","objective":"parkourMins"},"color":"green"},{"text":":","color":"green"},{"score":{"name":"@p[tag=templeader]","objective":"parkourSecs"},"color":"green"},{"text":".","color":"green"},{"score":{"name":"@p[tag=templeader]","objective":"parkourDeci"},"color":"green"},{"score":{"name":"@p[tag=templeader]","objective":"parkourDeci2"},"color":"green"}]'
