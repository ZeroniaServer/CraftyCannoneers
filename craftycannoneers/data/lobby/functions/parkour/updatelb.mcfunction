...
# TODO FIGURE OUT WHERE TO DO ALL OF THIS
...
#
# execute at @s run loot replace entity @e[type=armor_stand,tag=ParkourPlayer,limit=1] armor.head 1 loot cannons:playerhead
#
