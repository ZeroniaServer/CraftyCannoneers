...
##End parkour
execute as @a[team=Lobby,tag=inParkour] at @s if entity @s[x=-71,y=2,z=-4,dx=0,dy=0,dz=0] run tag @s add finishedParkour
execute as @a[team=Lobby,tag=finishedParkour] run advancement grant @s only tutorial:zzzunlockables/parkour
