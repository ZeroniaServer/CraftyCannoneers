...
execute if entity @s[scores={CombatTutorial=2}] run tellraw @s ["",{"text":"[2/7] ","color":"gray"},{"text":"Pirates are always equipped with a Cutlass and a Hand Crossbow. Other weapons can be found in different types of Treasure Chests.","color":"green"},"\n"]
execute if entity @s[scores={CombatTutorial=1}] run tellraw @s ["",{"text":"[1/7] ","color":"gray"},{"text":"In Crafty Cannoneers, you have access to a wide variety of weapons.","color":"green"},"\n"]
