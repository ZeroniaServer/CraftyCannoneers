...
execute if entity @s[scores={ChestTutorial=5}] run tellraw @s ["",{"text":"[5/7] ","color":"gray"},{"text":"Rare","bold":true,"color":"dark_purple"},{"text":": Gold, Gunpowder, Cannonballs, Arrows, Golden Apples, Trooper Ale, Shields, Weapons, Rare Weapons & Special Cannonballs.","color":"green"},"\n"]
execute if entity @s[scores={ChestTutorial=4}] run tellraw @s ["",{"text":"[4/7] ","color":"gray"},{"text":"Uncommon","bold":true,"color":"dark_aqua"},{"text":": Gold, Gunpowder, Cannonballs, Arrows, Golden Apples, Trooper Ale, Shields & Weapons.","color":"green"},"\n"]
execute if entity @s[scores={ChestTutorial=3}] run tellraw @s ["",{"text":"[3/7] ","color":"gray"},{"text":"Common","bold":true,"color":"gray"},{"text":": Gold, Gunpowder, Cannonballs, Arrows, & Golden Apples","color":"green"},"\n"]
