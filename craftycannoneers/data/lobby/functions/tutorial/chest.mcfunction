...
execute if entity @s[scores={ChestTutorial=5}] run tellraw @s ["",{"text":"[5/9] ","color":"gray"},{"text":"Rare","bold":true,"color":"dark_purple"},{"text":": Gold, Gunpowder, Cannonballs, Blast Bombs, Arrows, Golden Apples, Trooper Tonic, Shields, Rare Weapons & Special Cannonballs.","color":"green"},"\n"]
execute if entity @s[scores={ChestTutorial=4}] run tellraw @s ["",{"text":"[4/9] ","color":"gray"},{"text":"Uncommon","bold":true,"color":"dark_aqua"},{"text":": Gold, Gunpowder, Cannonballs, Blast Bombs, Arrows, Golden Apples, Trooper Tonic, Shields & Uncommon Weapons.","color":"green"},"\n"]
