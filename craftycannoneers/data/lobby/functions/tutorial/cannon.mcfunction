...
execute if entity @s[scores={CannonTutorial=5}] run tellraw @s ["",{"text":"[5/7] ","color":"gray"},{"text":"You can also preview your shot without losing Gunpowder by shooting a Tracer Cannonball instead. Tracer Cannonballs leave a green particle trail that only you can see, and you get them right back once they hit something.","color":"green"},"\n"]
