...
execute positioned -54 -23 9 run playsound minecraft:entity.evoker.prepare_summon master @a ~ ~ ~ 1 2
...
setblock -53 -22 9 minecraft:crimson_wall_sign{GlowingText:1b,Color:"light_blue",Text1:'{"text":"","clickEvent":{"action":"run_command","value":"trigger modisigns set 17863"}}',Text2:'{"text":""}',Text3:'{"text":""}',Text3:'{"text":"No Tracers","color":"#33ccff"}'}
