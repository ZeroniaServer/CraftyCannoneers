...
setblock -53 -24 9 minecraft:crimson_wall_sign{is_waxed:1b,front_text:{has_glowing_text:1b,color:"red",messages:['{"text":"","clickEvent":{"action":"run_command","value":"trigger modisigns set 6497"}}','{"text":""}','{"text":""}','{"translate":"customizer.restore_default","color":"#FF0003"}']}}
setblock -55 -24 9 minecraft:crimson_wall_sign{is_waxed:1b,front_text:{has_glowing_text:1b,color:"green",messages:['{"text":"","clickEvent":{"action":"run_command","value":"trigger modisigns set 5732"}}','{"text":""}','{"text":""}','{"translate":"customizer.confirm","color":"#00FF38"}']}}
setblock -54 -24 9 minecraft:crimson_wall_sign{is_waxed:1b,front_text:{has_glowing_text:1b,color:"light_blue",messages:['{"text":"","clickEvent":{"action":"run_command","value":"trigger modisigns set 9152"}}','{"text":""}','{"text":""}','{"translate":"customizer.modifiers","color":"#33ccff"}']}}
setblock -53 -22 9 minecraft:crimson_wall_sign{is_waxed:1b,front_text:{has_glowing_text:1b,color:"orange",messages:['{"text":"","clickEvent":{"action":"run_command","value":"trigger modisigns set 7853"}}','{"text":""}','{"translate":"customizer.game_time","color":"#FFFB00"}']}}
setblock -55 -22 9 minecraft:crimson_wall_sign{is_waxed:1b,front_text:{has_glowing_text:1b,color:"pink",messages:['{"text":"","clickEvent":{"action":"run_command","value":"trigger modisigns set 3384"}}','{"text":""}','{"translate":"customizer.ship_health","color":"#F8005B"}']}}
