...
execute if score $TimeLimit CmdData matches 30 run data merge block -53 -22 9 {Text4:'[{"text":"30 ","color":"#FF7200"},{"translate":"customizer.minutes","color":"#FF7200"}]'}
execute if score $TimeLimit CmdData matches 20 run data merge block -53 -22 9 {Text4:'[{"text":"20 ","color":"#FF7200"},{"translate":"customizer.minutes","color":"#FF7200"}]'}
execute if score $TimeLimit CmdData matches 15 run data merge block -53 -22 9 {Text4:'[{"text":"15 ","color":"#FF7200"},{"translate":"customizer.minutes","color":"#FF7200"}]'}
execute if score $TimeLimit CmdData matches 10 run data merge block -53 -22 9 {Text4:'[{"text":"10 ","color":"#FF7200"},{"translate":"customizer.minutes","color":"#FF7200"}]'}
