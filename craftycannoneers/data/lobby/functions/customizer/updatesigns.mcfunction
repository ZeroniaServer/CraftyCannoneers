...
execute if score $ModiMapActive CmdData matches 0 if score $Daytime CmdData matches 0 run item replace entity @e[type=item_display,tag=DaytimeIcon,limit=1] container.0 with diamond_hoe[custom_model_data=120]
...
execute if score $ModiMapActive CmdData matches 0 if score $Daytime CmdData matches 1 run item replace entity @e[type=item_display,tag=DaytimeIcon,limit=1] container.0 with diamond_hoe[custom_model_data=121]
...
execute if score $ModiMapActive CmdData matches 0 if score $Daytime CmdData matches 2 run item replace entity @e[type=item_display,tag=DaytimeIcon,limit=1] container.0 with diamond_hoe[custom_model_data=122]