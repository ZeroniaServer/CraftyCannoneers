...
execute positioned -54 -23 9 run playsound modifier.close master @a ~ ~ ~ 1 1.8
...
setblock -54 -24 9 minecraft:crimson_wall_sign{GlowingText:1b,Color:"green",Text1:'{"text":"","clickEvent":{"action":"run_command","value":"trigger modisigns set 5732"}}',Text2:'{"text":""}',Text3:'{"text":""}',Text4:'{"translate":"customizer.confirm","color":"#00FF38"}'}
setblock -55 -24 9 minecraft:crimson_wall_sign{GlowingText:1b,Color:"light_blue",Text1:'{"text":"","clickEvent":{"action":"run_command","value":"trigger modisigns set 9152"}}',Text2:'{"text":""}',Text3:'{"text":""}',Text4:'{"translate":"customizer.modifiers","color":"#33ccff"}'}
