...
setblock -54 -24 9 crimson_wall_sign[facing=north]{front_text:{color:"light_gray",has_glowing_text:1b,messages:['{"translate":"customizer.cancel"}','{"translate":"customizer.cancel.available_in","italic":true,"with":[{"text":"10"}]}','{"text":"","clickEvent":{"action":"run_command","value":"/trigger cancelMatch set 1"},"italic":true}','{"text":""}']}}
