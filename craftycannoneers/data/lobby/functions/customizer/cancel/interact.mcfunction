...
execute if score $gamestate CmdData matches 0 unless score $mcancel CmdData matches -1 if score $mcancelcount CmdData matches 2.. run tellraw @s [{"text":"[","color":"dark_gray"},{"text":"!","color":"red","bold":true},{"text":"] ","color":"dark_gray"},{"translate":"chat.cannot_cancel.seconds","color":"red","with":[{"score":{"name":"$mcancelcount","objective":"CmdData"},"color":"white","bold":true}]}]
execute if score $gamestate CmdData matches 0 unless score $mcancel CmdData matches -1 if score $mcancelcount CmdData matches 1 run tellraw @s [{"text":"[","color":"dark_gray"},{"text":"!","color":"red","bold":true},{"text":"] ","color":"dark_gray"},{"translate":"chat.cannot_cancel.second","color":"red","with":[{"text":"1","color":"white","bold":true}]}]
