...
execute if score $mcancelcount CmdData matches 0 run data modify block -55 -22 9 front_text.messages[2] set value '{"translate":"customizer.cancel","color":"#ff8585"}'
execute if score $mcancelcount CmdData matches 0 run data modify block -55 -22 9 front_text.color set value "red"
...
data modify block -55 -22 9 front_text.messages[2] set value '{"translate":"customizer.cancel.available_in","with":[{"score":{"name":"$mcancelcount","objective":"CmdData"}}]}'
