...
execute if score $Sharks CmdData matches 1 run data modify storage craftycannoneers:modifiers list append value '{"translate":"modifier.wildlife","color":"aqua","hoverEvent":{"action":"show_text","contents":["",{"translate":"modifier.wildlife.description","color":"white"}]}}'
