...
execute if score $GraveRobbery CmdData matches 0 run data merge block -54 -23 9 {Text4:'{"text":"❌","color":"#FF282E","bold":true}'}
execute if score $GraveRobbery CmdData matches 1 run data merge block -54 -23 9 {Text4:'{"text":"✔","color":"#28FF3E","bold":true}'}