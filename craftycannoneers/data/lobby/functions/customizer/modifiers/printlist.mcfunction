...
execute unless score $currentline CmdData matches 1 if data storage craftycannoneers:modifiers line[1] run tellraw @a {"translate":"customizer.current_modifiers","color":"#4e5c24","with":[["",{"nbt":"line[0][]","storage":"craftycannoneers:modifiers","interpret":true,"separator":{"text":", ","color":"gray"}},{"text":", ","color":"gray"}]]}
