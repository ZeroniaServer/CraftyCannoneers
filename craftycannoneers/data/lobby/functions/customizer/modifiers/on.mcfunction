...
setblock -54 -22 9 minecraft:crimson_wall_sign{GlowingText:1b,Color:"light_blue",Text1:'{"text":"","clickEvent":{"action":"run_command","value":"trigger modisigns set 59636"}}',Text2:'{"text":""}',Text3:'{"translate":"modifier.wildlife","color":"#33ccff"}'}
