...
execute if score $modifiersLeft CmdData matches 1.. run data modify storage craftycannoneers:modifiers line[-1] append from storage craftycannoneers:modifiers list[0]
execute if score $modifiersLeft CmdData matches 1.. run data remove storage craftycannoneers:modifiers list[0]
execute store result score $modifiersLeft CmdData run data get storage craftycannoneers:modifiers list

#Tracks line length and creates a new list for the next line if it exceeds this value
execute if score $modifiersLeft CmdData matches 1.. store result score $tempLineLength CmdData run data get storage craftycannoneers:modifiers length[0]
execute if score $modifiersLeft CmdData matches 1.. run data remove storage craftycannoneers:modifiers length[0]
