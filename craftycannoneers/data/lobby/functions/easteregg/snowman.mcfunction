...
execute at @s[scores={CmdData=120}] run give @a[distance=..6] snow_block{NoDrop:1b,display:{Name:'[{"translate":"block.minecraft.snow_block","italic":false,"color":"light_purple"}]',Lore:['[{"translate":"item.snow_block.lore","color":"dark_gray"},{"text":"","color":"dark_purple","italic":false}]']},HideFlags:3}
