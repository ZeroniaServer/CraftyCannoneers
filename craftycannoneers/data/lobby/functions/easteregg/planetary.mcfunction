...
execute unless score $planetary CmdData matches 1 run particle block iron_block ~-0.2 ~ ~ 0.1 0.1 0.1 1 3
execute unless score $planetary CmdData matches 1 run particle block chorus_plant ~0.2 ~ ~ 0.1 0.1 0.1 1 3
