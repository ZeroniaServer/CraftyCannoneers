...
execute at @s[scores={CmdData=135}] run particle minecraft:falling_water ~ ~ ~ 0.5 1 0.5 0.5 50
execute at @s[scores={CmdData=135}] run particle minecraft:splash ~ ~ ~ 0.5 1 0.5 0.5 50
execute at @s[scores={CmdData=135}] run playsound snowmanleave master @a ~ ~ ~ 1 1.4
execute at @s[scores={CmdData=135}] run playsound minecraft:entity.generic.splash master @a ~ ~ ~ 1 1.4
