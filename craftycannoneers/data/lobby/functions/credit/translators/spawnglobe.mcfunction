...
summon text_display -35 -25.7 19 {Tags:["TranslatorCredit","GlobeText"],billboard:"center",transformation:{translation:[0f,0f,0f],scale:[0.6f,0.6f,0.6f]},text:'[{"translate":"credits.translators","color":"white"}]',alignment:"center"}
