...
summon minecraft:item_display -35 -27 19 {Tags:["TranslatorCredit","Stand"],item_display:"fixed",item:{id:"minecraft:diamond_hoe",Count:1b,components:{"custom_model_data":137}},width:1f,height:1f}
