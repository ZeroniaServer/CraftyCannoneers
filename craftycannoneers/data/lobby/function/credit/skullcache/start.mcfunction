tag @e[x=0,type=item_display,tag=SkullCache] add Old

#> Translators
#ZeroIceBear
summon item_display 0 -100 0 {Tags:["SkullCache","icebear"],view_range:0,start_interpolation:0,interpolation_duration:0,transformation:{scale:[0f,0f,0f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},item_display:"fixed",item:{id:"minecraft:player_head",count:1,components:{"minecraft:custom_data":{name:"icebear"},"minecraft:profile":{id:[I;2009721405,-2095561811,-1075379032,1294848694]}}}}

#Yatloaf
summon item_display 0 -100 0 {Tags:["SkullCache","yat"],view_range:0,start_interpolation:0,interpolation_duration:0,transformation:{scale:[0f,0f,0f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},item_display:"fixed",item:{id:"minecraft:player_head",count:1,components:{"minecraft:custom_data":{name:"yat"},"minecraft:profile":{id:[I;1356720797,-1795994109,-1552605678,1039199064]}}}}

#CapitaineMinus
summon item_display 0 -100 0 {Tags:["SkullCache","minus"],view_range:0,start_interpolation:0,interpolation_duration:0,transformation:{scale:[0f,0f,0f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},item_display:"fixed",item:{id:"minecraft:player_head",count:1,components:{"minecraft:custom_data":{name:"minus"},"minecraft:profile":{id:[I;-992945998,1903381236,-1700006286,47222600]}}}}
...
#Stuffy
summon item_display 0 -100 0 {Tags:["SkullCache","stuffy"],view_range:0,start_interpolation:0,interpolation_duration:0,transformation:{scale:[0f,0f,0f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},item_display:"fixed",item:{id:"minecraft:player_head",count:1,components:{"minecraft:custom_data":{name:"stuffy"},"minecraft:profile":{id:[I;754748853,1911377587,-1429384264,-1409327390]}}}}

#Evtema3
summon item_display 0 -100 0 {Tags:["SkullCache","evtema"],view_range:0,start_interpolation:0,interpolation_duration:0,transformation:{scale:[0f,0f,0f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},item_display:"fixed",item:{id:"minecraft:player_head",count:1,components:{"minecraft:custom_data":{name:"evtema"},"minecraft:profile":{id:[I;1143768566,1044072941,-1808662431,483304317]}}}}

#Klariaon
summon item_display 0 -100 0 {Tags:["SkullCache","klar"],view_range:0,start_interpolation:0,interpolation_duration:0,transformation:{scale:[0f,0f,0f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},item_display:"fixed",item:{id:"minecraft:player_head",count:1,components:{"minecraft:custom_data":{name:"klar"},"minecraft:profile":{id:[I;163135226,1671055797,-1293222910,1897519542]}}}}
