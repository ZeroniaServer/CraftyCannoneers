...
setblock -54 -24 9 crimson_wall_sign[facing=north]{front_text:{color:"light_gray",has_glowing_text:1b,messages:[{text:""},{translate:"customizer.cancel.available_in",with:[{text:"10"}]},{text:"",click_event:{action:"run_command",command:"/trigger cancelMatch set 1"}},{text:""}]}}
