...
execute at @s[scores={CmdData=45}] run summon area_effect_cloud ~ ~1.7 ~ {Tags:["EasterEgg","SnowmanText"],Duration:30,CustomNameVisible:1b,CustomName:{translate:"easter_egg.snowman.1"},WaitTime:0,Radius:0f,custom_particle:{type:"block",block_state:"minecraft:air"}}
execute at @s[scores={CmdData=45}] run playsound snowmanspeak master @a ~ ~ ~ 1 1
execute at @s[scores={CmdData=75}] run summon area_effect_cloud ~ ~1.7 ~ {Tags:["EasterEgg","SnowmanText"],Duration:30,CustomNameVisible:1b,CustomName:{translate:"easter_egg.snowman.2"},WaitTime:0,Radius:0f,custom_particle:{type:"block",block_state:"minecraft:air"}}
