...
loot replace entity @s hotbar.0 27 mine 0 300 0 stick[custom_data={drop_contents:1b}]
...
loot replace entity @s inventory.18 9 mine 0 300 0 stick[custom_data={drop_contents:1b}]

#> Copy offhand
data modify block 0 300 0 Items set value []
data modify block 0 300 0 Items set from entity @s EnderItems[2].tag.BlockEntityTag.Items
loot replace entity @s weapon.offhand 1 mine 0 300 0 stick[custom_data={drop_contents:1b}]
