summon chest_minecart ~ ~ ~ {LootTable:"chests:empty",Silent:1b,Invulnerable:1b,Rotation:[-90.0f, 0.0f],Tags:["fakechest","fakelockedchest"],CustomName:[{translate:"space.-48"},{text:"\uE02D",color:"#7b7b00"},{translate:"space.-4096"}],DisplayState:{Name:"minecraft:air"}}
