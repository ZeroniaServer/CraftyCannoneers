...
tellraw @s[tag=Newcomer,tag=!hideTips] ["",{"text":"Welcome to the ","color":"dark_green"},{"text":"Training Island","bold":true,"color":"aqua"},{"text":"!","color":"dark_green"},"\n",{"text":"Here you can learn about important game mechanics by talking to the Pirate Teachers at each area and playing around with things for yourself!","color":"green"},"\n",{"text":"(Speak to all 4 Pirate Teachers on this island to get rid of these Newcomer notifications!)","italic":true,"color":"dark_green"}]
