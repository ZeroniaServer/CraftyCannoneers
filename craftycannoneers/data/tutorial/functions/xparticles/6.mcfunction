...
#fade 1
execute if entity @s[tag=S6] at @s run particle dust 1.275 0.445 0.445 1.6 ~0.5 ~ ~ 0 0 0 0 1 force @a[tag=InTower,tag=Exposed6,scores={fakeexpose6=200..240}]

#fade 2
execute if entity @s[tag=S6] at @s run particle dust 1.275 0.805 0.805 1.3 ~0.5 ~ ~ 0 0 0 0 1 force @a[tag=InTower,tag=Exposed6,scores={fakeexpose6=240..270}]

#fade 3
execute if entity @s[tag=S6] at @s run particle dust 1.275 1.085 1.085 1.2 ~0.5 ~ ~ 0 0 0 0 1 force @a[tag=InTower,tag=Exposed6,scores={fakeexpose6=270..}]
