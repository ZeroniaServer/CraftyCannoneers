...
#fade 1
execute if score $dust3 CmdData matches 0 at @s run particle dust 1 0.35 0.35 1.6 ~0.5 ~ ~ 0 0 0 0 0 force @a[tag=InTower,tag=Exposed6,scores={fakeexpose6=200..240}]
