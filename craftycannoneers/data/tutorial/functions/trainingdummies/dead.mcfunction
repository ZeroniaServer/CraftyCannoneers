...
execute if score @s eyeclick matches 1 run particle block hay_block ^-0.2 ^1 ^ 0 0.1 0 0.1 20
execute if score @s eyeclick matches 2 run summon marker ~ ~ ~ {Tags:["DummyRespawn","TrainingDummy"]}
...
execute if score @s eyeclick matches 2 run summon item ~ ~1.2 ~ {Tags:["DummyDeadItem","hat"],Item:{id:"minecraft:diamond_hoe",tag:{CustomModelData:39},Count:1b},PickupDelay:1000,Motion:[-0.05d,0.2d,-0.05d]}
