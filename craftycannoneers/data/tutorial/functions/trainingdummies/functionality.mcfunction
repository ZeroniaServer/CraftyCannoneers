...
execute as @e[tag=DummyDead,scores={eyeclick=1}] at @s run playsound minecraft:block.wool.hit master @a ~ ~ ~ 1 1
execute as @e[tag=DummyDead,scores={eyeclick=1}] at @s run playsound minecraft:block.wool.hit master @a ~ ~ ~ 1 0
execute as @e[tag=DummyDead,scores={eyeclick=1}] at @s run playsound minecraft:entity.armor_stand.hit master @a ~ ~ ~ 1 0.7
execute as @e[tag=DummyDead,scores={eyeclick=1}] at @s run playsound minecraft:entity.armor_stand.hit master @a ~ ~ ~ 1 2
execute as @e[tag=DummyDead,scores={eyeclick=1}] run item replace entity @s armor.head with air 
execute as @e[tag=DummyDead,scores={eyeclick=1}] at @s run particle cloud ~ ~ ~ 0 0 0 0.2 10
execute as @e[tag=DummyDead,scores={eyeclick=1}] at @s run particle block oak_planks ~ ~1.3 ~ 0 0.3 0 0.1 50
execute as @e[tag=DummyDead,scores={eyeclick=1}] at @s run particle block hay_block ^0.2 ^1 ^ 0 0.1 0 0.1 20
execute as @e[tag=DummyDead,scores={eyeclick=1}] at @s run particle block hay_block ^-0.2 ^1 ^ 0 0.1 0 0.1 20
execute as @e[tag=DummyDead,scores={eyeclick=2}] at @s run summon item ~ ~1.2 ~ {Tags:["DummyDeadItem","pumpkin"],Item:{id:"minecraft:carved_pumpkin",Count:1b},PickupDelay:1000,Motion:[0.03d,0.2d,0.05d]}
...
execute as @e[tag=DummyDead,scores={eyeclick=2}] at @s run summon item ~ ~1.2 ~ {Tags:["DummyDeadItem","wheat"],Item:{id:"minecraft:wheat",Count:1b},PickupDelay:1000,Motion:[-0.05d,0.25d,0.05d]}
execute as @e[type=item,tag=DummyDeadItem,tag=!UUIDConfirmed] run data modify entity @s Item.tag.hash set from entity @s UUID[0]
execute as @e[tag=DummyDead,scores={eyeclick=2}] at @s run summon item ~ ~1.2 ~ {Tags:["DummyDeadItem","wheat"],Item:{id:"minecraft:wheat",Count:1b},PickupDelay:1000,Motion:[-0.01d,0.22d,0.05d]}
execute as @e[type=item,tag=DummyDeadItem,tag=!UUIDConfirmed] run data modify entity @s Item.tag.hash set from entity @s UUID[0]
execute as @e[tag=DummyDead,scores={eyeclick=2}] at @s run summon item ~ ~1.2 ~ {Tags:["DummyDeadItem","wheat"],Item:{id:"minecraft:wheat",Count:1b},PickupDelay:1000,Motion:[0.05d,0.2d,-0.02d]}
execute as @e[type=item,tag=DummyDeadItem,tag=!UUIDConfirmed] run data modify entity @s Item.tag.hash set from entity @s UUID[0]
execute as @e[tag=DummyDead,scores={eyeclick=2}] at @s run summon item ~ ~1.2 ~ {Tags:["DummyDeadItem","hat"],Item:{id:"minecraft:diamond_hoe",tag:{CustomModelData:39},Count:1b},PickupDelay:1000,Motion:[-0.05d,0.2d,-0.05d]}
execute as @e[type=item,tag=DummyDeadItem,tag=!UUIDConfirmed] run data modify entity @s Item.tag.hash set from entity @s UUID[0]
tag @e[type=item,tag=DummyDeadItem,tag=!UUIDConfirmed] add UUIDConfirmed
execute as @e[tag=DummyDead,scores={eyeclick=5..}] at @s run kill @e[type=area_effect_cloud,tag=NameTag,distance=..2,limit=1,sort=nearest]
execute as @e[tag=DummyDead,scores={eyeclick=5..}] at @s run kill @s

scoreboard players add @e[tag=DummyDeadItem] CmdData 1
execute as @e[tag=DummyDeadItem,tag=wheat,scores={CmdData=36}] at @s run particle item wheat ~ ~0.3 ~ 0 0 0 0.1 12
execute as @e[tag=DummyDeadItem,tag=pumpkin,scores={CmdData=36}] at @s run particle block carved_pumpkin ~ ~0.3 ~ 0 0 0 0.1 12
execute as @e[tag=DummyDeadItem,tag=hat,scores={CmdData=36}] at @s run particle block black_wool ~ ~0.3 ~ 0 0 0 0.1 12
execute as @e[tag=DummyDeadItem,scores={CmdData=40..}] run kill @s