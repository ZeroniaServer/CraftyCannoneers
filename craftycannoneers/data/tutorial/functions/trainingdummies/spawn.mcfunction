...
execute unless entity @s[tag=45] unless entity @s[tag=90] unless entity @s[tag=135] run summon armor_stand ~ ~ ~ {Tags:["TrainingDummy","TDAS"],Invisible:1b,NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",Count:1b,tag:{CustomModelData:77}}]}
execute if entity @s[tag=45] run summon armor_stand ~ ~ ~ {Tags:["TrainingDummy","TDAS"],Invisible:1b,NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",Count:1b,tag:{CustomModelData:77}}],Rotation:[45.0f,0.0f]}
execute if entity @s[tag=90] run summon armor_stand ~ ~ ~ {Tags:["TrainingDummy","TDAS"],Invisible:1b,NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",Count:1b,tag:{CustomModelData:77}}],Rotation:[90.0f,0.0f]}
execute if entity @s[tag=135] run summon armor_stand ~ ~ ~ {Tags:["TrainingDummy","TDAS"],Invisible:1b,NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",Count:1b,tag:{CustomModelData:77}}],Rotation:[135.0f,0.0f]}
