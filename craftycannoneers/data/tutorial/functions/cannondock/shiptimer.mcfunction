...
execute if score $shiptimer CmdData matches 1160 run title @a[team=Lobby,tag=OnDock] actionbar ["",{"translate":"tutorial.ship_timer.dual_second","color":"aqua","with":[{"text":"2","bold":true,"color":"blue"}]}]
