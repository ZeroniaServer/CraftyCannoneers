...
setblock -49 -28 -3 oak_wall_sign[facing=east,waterlogged=false]{front_text:{has_glowing_text:0b,color:"black",messages:['{"clickEvent":{"action":"run_command","value":"trigger leavegame"},"text":""}','{"color":"#00CCCC","text":"Click here to"}','{"extra":[{"color":"#55FFFF","text":"Leave"},{"color":"#00CCCC","text":" your team!"}],"text":""}','{"text":""}']}}
setblock -49 -28 3 air
setblock -49 -28 3 oak_wall_sign[facing=east,waterlogged=false]{front_text:{has_glowing_text:0b,color:"black",messages:['{"clickEvent":{"action":"run_command","value":"trigger leavegame"},"text":""}','{"color":"#00CCCC","text":"Click here to"}','{"extra":[{"color":"#55FFFF","text":"Leave"},{"color":"#00CCCC","text":" your team!"}],"text":""}','{"text":""}']}}
