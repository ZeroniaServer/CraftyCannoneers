...
execute at @s[scores={CmdData=40}] run particle item{item:"mooshroom_spawn_egg",components:{"minecraft:custom_model_data":15}} ~ ~0.5 ~ 0.2 0.25 0.2 0.1 40 force @a[team=!Lobby]
