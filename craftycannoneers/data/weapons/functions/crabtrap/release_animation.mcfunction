...
execute at @s[scores={CmdData=10}] run playsound minecraft:entity.zombie.attack_wooden_door master @a ~ ~ ~ 0.6 1.4
execute at @s[scores={CmdData=10..11}] run tp @s ~ ~ ~ ~4 ~
execute as @s[scores={CmdData=12..13}] run tp @s ~ ~ ~ ~-4 ~
execute at @s[scores={CmdData=30}] run playsound minecraft:entity.zombie.attack_wooden_door master @a ~ ~ ~ 0.6 1.5
...
execute at @s[scores={CmdData=40,TrapDurability=0..}] run playsound minecraft:entity.zombie.attack_wooden_door master @a ~ ~ ~ 0.6 1.5
execute at @s[scores={CmdData=40,TrapDurability=0..}] run playsound minecraft:entity.zombie.break_wooden_door master @a ~ ~ ~ 0.6 2
execute at @s[scores={CmdData=40,TrapDurability=0..}] run playsound minecraft:block.wooden_trapdoor.open master @a ~ ~ ~ 0.6 1.1

execute at @s[scores={CmdData=40,TrapDurability=..-1}] run playsound minecraft:entity.zombie.attack_wooden_door master @a ~ ~ ~ 0.2 1.5
execute at @s[scores={CmdData=40,TrapDurability=..-1}] run playsound minecraft:entity.zombie.break_wooden_door master @a ~ ~ ~ 0.2 2
