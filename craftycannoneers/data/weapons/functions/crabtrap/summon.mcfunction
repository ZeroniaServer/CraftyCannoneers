...
execute if entity @s[tag=Empty] run tag @e[type=endermite,tag=CrabVehicle,distance=..1] add CrabtrapImmune
execute if entity @s[tag=Empty] run tag @e[type=cat,tag=CrabVehicle,distance=..1] add CrabtrapImmune
