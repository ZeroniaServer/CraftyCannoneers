...
execute unless score $landed CmdData matches 1 at @s unless block ^ ^ ^2 #cannons:cannonball_passable run scoreboard players set $landed CmdData 1
execute unless score $landed CmdData matches 1 at @s unless block ^ ^ ^1 #cannons:cannonball_passable run scoreboard players set $landed CmdData 1
execute unless score $landed CmdData matches 1 at @s unless block ^ ^ ^ #cannons:cannonball_passable run scoreboard players set $landed CmdData 1
