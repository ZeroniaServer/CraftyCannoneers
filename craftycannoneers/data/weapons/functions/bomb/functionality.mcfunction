...
execute as @e[type=armor_stand,tag=Bomb,tag=Kaboom,scores={BombDelay=5}] at @s run summon slime ~ ~-33 ~ {NoAI:1b,Invulnerable:1b,Silent:1b,Attributes:[{Name:"generic.attack_damage",Base:0f}],Tags:["BlastSlime"],Size:16,NoAI:0b,NoGravity:1b,Invulnerable:1b}
execute as @e[type=armor_stand,tag=Bomb,tag=Kaboom,scores={BombDelay=5}] at @s run summon slime ~ ~-33 ~ {NoAI:1b,Invulnerable:1b,Silent:1b,Attributes:[{Name:"generic.attack_damage",Base:0f}],Tags:["BlastSlime"],Size:16,NoAI:0b,NoGravity:1b,Invulnerable:1b}
execute as @e[type=armor_stand,tag=Bomb,tag=Kaboom,scores={BombDelay=5}] at @s run summon slime ~ ~-33 ~ {NoAI:1b,Invulnerable:1b,Silent:1b,Attributes:[{Name:"generic.attack_damage",Base:0f}],Tags:["BlastSlime"],Size:16,NoAI:0b,NoGravity:1b,Invulnerable:1b}
execute as @e[type=armor_stand,tag=Bomb,tag=Kaboom,scores={BombDelay=5}] at @s run summon slime ~ ~-33 ~ {NoAI:1b,Invulnerable:1b,Silent:1b,Attributes:[{Name:"generic.attack_damage",Base:0f}],Tags:["BlastSlime"],Size:16,NoAI:0b,NoGravity:1b,Invulnerable:1b}
execute as @e[type=armor_stand,tag=Bomb,tag=Kaboom,scores={BombDelay=5}] at @s run summon slime ~ ~-33 ~ {NoAI:1b,Invulnerable:1b,Silent:1b,Attributes:[{Name:"generic.attack_damage",Base:0f}],Tags:["BlastSlime"],Size:16,NoAI:0b,NoGravity:1b,Invulnerable:1b}
