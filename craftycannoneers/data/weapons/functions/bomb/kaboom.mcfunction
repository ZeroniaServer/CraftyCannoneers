...
execute if score @s BombDelay matches 1 run tag @a[tag=!Blasted,gamemode=!spectator,distance=..5] add Blasted
...
execute if score @s BombDelay matches 2.. as @e[type=item_display,tag=CrabTrap,distance=..4] at @s run function weapons:crabtrap/break
