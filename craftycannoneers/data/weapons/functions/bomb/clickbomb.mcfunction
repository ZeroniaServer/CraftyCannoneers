...
item modify entity @s[predicate=weapons:bomb_mainhand] weapon.mainhand game:reducecount
item modify entity @s[predicate=weapons:bomb_offhand] weapon.offhand game:reducecount
tag @s add BombDelay