...
execute at @s run summon snowball ~ ~1.62 ~ {Silent:1b,Tags:["Bomb","ThrowBomb","bomb"],Item:{id:"minecraft:ender_eye",tag:{CustomModelData:2},Count:1},Passengers:[{id:"item_display",Tags:["Bomb","bomb","BombTracker"],item_display:"ground",width:1f,height:1f,billboard:"vertical",transformation:{translation:[0.0f,-0.2f,0.0f],scale:[1f,1f,1f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]}}]}
