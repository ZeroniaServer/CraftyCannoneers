...
execute at @s run summon potion ~ ~1.5 ~ {Silent:1b,Tags:["Bomb","ThrowBomb","bomb"],Item:{id:"minecraft:slime_ball",Count:1,tag:{CustomPotionColor:52479}},Passengers:[{id:"item_display",Tags:["Bomb","bomb","BombTracker"],item:{id:"minecraft:ender_eye",Count:1,tag:{CustomModelData:2}},item_display:"head",width:1f,height:1f,billboard:"center"}]}
