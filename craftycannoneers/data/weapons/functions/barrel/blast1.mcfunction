...
data modify storage craftycannoneers:blastbomb Motion set value [0d, 0.5d, 0d]
execute store result storage craftycannoneers:blastbomb Motion[0] double 0.0005 run scoreboard players get @s dx
execute store result storage craftycannoneers:blastbomb Motion[2] double 0.0005 run scoreboard players get @s dz
tp @s @s
