...
execute if block ~ ~ ~ #game:barrel_exclude run playsound blastbarrelplace master @a ~ ~ ~ 0.6 1
execute if block ~ ~ ~ #game:barrel_exclude run particle item mooshroom_spawn_egg{CustomModelData:1} ~ ~ ~ 0.4 0 0.4 0.1 5 force @a[team=!Lobby]
execute if block ~ ~ ~ #game:barrel_exclude run particle cloud ~ ~0.1 ~ 0.2 0.1 0.2 0.03 3 force @a[team=!Lobby]
