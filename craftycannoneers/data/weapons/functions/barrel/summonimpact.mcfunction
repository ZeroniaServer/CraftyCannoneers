...
execute as @e[type=marker,tag=ImpactMarker,tag=BlastBarrel,limit=1] at @s run function cannons:spawncreeper
execute if predicate cannons:ships/purple run scoreboard players add $DamagePurple CmdData 15
execute if score @s CmdData matches 10 if predicate cannons:ships/purple run scoreboard players add $CritPurple CmdData 100
execute if predicate cannons:ships/orange run scoreboard players add $DamageOrange CmdData 15
execute if score @s CmdData matches 10 if predicate cannons:ships/orange run scoreboard players add $CritOrange CmdData 100
