...
execute at @s[type=marker,tag=BarrelMaxFX,tag=NS,scores={CmdData=8..}] run particle dust 1 0 0 1 ~ ~1 ~ 0 1 4 0 10 force @a[team=!Lobby]
execute at @s[type=marker,tag=BarrelMaxFX,tag=NS,scores={CmdData=8..}] run particle explosion ~ ~ ~ 0 1 4 0 10 force @a[team=!Lobby]
...
execute at @s[type=marker,tag=BarrelMaxFX,tag=EW,scores={CmdData=8..}] run particle dust 1 0 0 1 ~ ~1 ~ 4 1 0 0 10 force @a[team=!Lobby]
execute at @s[type=marker,tag=BarrelMaxFX,tag=EW,scores={CmdData=8..}] run particle explosion ~ ~ ~ 4 1 0 0 10 force @a[team=!Lobby]
