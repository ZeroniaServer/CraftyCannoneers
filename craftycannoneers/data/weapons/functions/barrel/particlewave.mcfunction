...
execute at @s[tag=BarrelMaxFX,tag=NS,scores={CmdData=1..7}] run particle dust{color:[1.0,0.0,0.0],scale:1.0} ~ ~1 ~ 0 2 4 0 10 force @a[team=!Lobby]
execute at @s[tag=BarrelMaxFX,tag=NS,scores={CmdData=1..7}] run particle explosion ~ ~ ~ 0 2 4 0 10 force @a[team=!Lobby]
execute at @s[tag=BarrelMaxFX,tag=NS,scores={CmdData=8..}] run particle dust{color:[1.0,0.0,0.0],scale:1.0} ~ ~1 ~ 0 1 4 0 4 force @a[team=!Lobby]
...
execute at @s[tag=BarrelMaxFX,tag=EW,scores={CmdData=1..7}] run particle dust{color:[1.0,0.0,0.0],scale:1.0} ~ ~1 ~ 4 2 0 0 10 force @a[team=!Lobby]
execute at @s[tag=BarrelMaxFX,tag=EW,scores={CmdData=1..7}] run particle explosion ~ ~ ~ 4 2 0 0 10 force @a[team=!Lobby]
execute at @s[tag=BarrelMaxFX,tag=EW,scores={CmdData=8..}] run particle dust{color:[1.0,0.0,0.0],scale:1.0} ~ ~1 ~ 4 1 0 0 4 force @a[team=!Lobby]
