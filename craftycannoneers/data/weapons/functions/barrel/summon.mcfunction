...
summon villager ~ ~ ~ {NoAI:1b,Silent:1b,NoGravity:1b,Age:-2147483648,Tags:["BlastBarrel","BarrelVillager"],PersistenceRequired:1b,DeathTime:19s,ActiveEffects:[{Id:11,Amplifier:100b,Duration:-1,ShowParticles:0b}],Passengers:[{id:"minecraft:marker",Tags:["villager","bbarrel"],data:{Tags:["BlastBarrel","BarrelVillager"]}}]}
