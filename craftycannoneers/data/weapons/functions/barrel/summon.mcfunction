...
summon husk ~ ~-1 ~ {NoAI:1b,Silent:1b,NoGravity:1b,Tags:["BlastBarrel"],PersistenceRequired:1b,DeathTime:17s,ActiveEffects:[{Id:7,Amplifier:10b,Duration:-1,ShowParticles:0b}]}
team join NoName @e[type=husk,tag=BlastBarrel,limit=1,sort=nearest]
