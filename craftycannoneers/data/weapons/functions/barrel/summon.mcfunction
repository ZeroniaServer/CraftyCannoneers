...
summon bat ~ ~0.01 ~ {NoAI:1b,Silent:1b,NoGravity:1b,Tags:["BlastBarrel"],PersistenceRequired:1b,DeathTime:17s,ActiveEffects:[{Id:6,Amplifier:10b,Duration:-1,ShowParticles:0b},{Id:11,Amplifier:127b,Duration:-1,ShowParticles:0b},{Id:21,Amplifier:127b,Duration:-1,ShowParticles:0b}]}
