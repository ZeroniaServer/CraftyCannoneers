...
particle flash{color:0xFFFFFF} ~ ~1 ~ 0 0 0 0 2 force @a[team=!Lobby]
particle dust{color:[1.0,0.0,0.0],scale:2.0} ~ ~1 ~ 3 3 3 0 40 force @a[team=!Lobby]
...
#> Break nearby Boats
kill @e[type=oak_boat,tag=BoatBoat,distance=..7.5]
...
execute as @e[type=splash_potion,distance=..7.5] run function weapons:barrel/blast2
