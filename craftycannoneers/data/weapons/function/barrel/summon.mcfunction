...
execute if score $angle CmdData matches 0 run summon item_display ~ ~ ~ {item_display:"head",Tags:["BlastBarrel"],item:{id:"minecraft:mooshroom_spawn_egg",count:1,components:{"custom_model_data":1}}}
...
execute if score $angle CmdData matches 1 run summon item_display ~ ~ ~ {Rotation:[90f,0f],item_display:"head",Tags:["BlastBarrel"],item:{id:"minecraft:mooshroom_spawn_egg",count:1,components:{"custom_model_data":1}}}
