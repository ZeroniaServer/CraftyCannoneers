...
execute at @s run summon potion ~ ~1.5 ~ {Silent:1b,Tags:["Bomb","ThrowBomb","bomb"],Item:{id:"minecraft:slime_ball",count:1},Passengers:[{id:"item_display",Tags:["Bomb","bomb","BombTracker"],teleport_duration:2,item:{id:"minecraft:ender_eye",components:{"minecraft:custom_model_data":2},count:1},item_display:"head",width:1f,height:1f,billboard:"center"},{id:"breeze_wind_charge",Tags:["BlastCharge","BlastCharge1"]},{id:"breeze_wind_charge",Tags:["BlastCharge","BlastCharge2"]}]}
