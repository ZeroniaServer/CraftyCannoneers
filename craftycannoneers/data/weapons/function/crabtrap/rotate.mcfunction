...
$execute unless entity @s[tag=Empty] run summon item_display ~ ~ ~ {height:0.6f,width:0.8f,Rotation:[$(angle)f, 0.0f],teleport_duration:1,item_display:"fixed",Tags:["CrabTrap","CrabTrapDisplay","new"],item:{id:"minecraft:mooshroom_spawn_egg",count:1,components:{"custom_model_data":{floats:[16.0f]}}}}
