...
$execute if entity @s[tag=Empty] run summon interaction ~ ~ ~ {Tags:["CrabTrap"],height:0.6f,width:0.8f,Passengers:[{id:"item_display",height:0.6f,width:0.8f,Rotation:[$(angle)f, 0.0f],item_display:"fixed",Tags:["CrabTrap","CrabTrapDisplay","new"],item:{id:"minecraft:mooshroom_spawn_egg",count:1,components:{"custom_model_data":{floats:[15.0f]}}}}]}
