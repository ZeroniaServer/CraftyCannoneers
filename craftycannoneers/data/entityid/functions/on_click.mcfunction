...
execute if entity @s[tag=TutorialWeapon,tag=Cutlass] as @p[tag=clicker] at @s run function tutorial:weapons/cutlass
execute if entity @s[tag=TutorialWeapon,tag=Saber] as @p[tag=clicker] at @s run function tutorial:weapons/saber
execute if entity @s[tag=TutorialWeapon,tag=BoardingAxe] as @p[tag=clicker] at @s run function tutorial:weapons/boardingaxe
execute if entity @s[tag=TutorialWeapon,tag=BattleAxe] as @p[tag=clicker] at @s run function tutorial:weapons/battleaxe
execute if entity @s[tag=TutorialWeapon,tag=Mace] as @p[tag=clicker] at @s run function tutorial:weapons/mace
execute if entity @s[tag=TutorialWeapon,tag=Hook] as @p[tag=clicker] at @s run function tutorial:weapons/hook
execute if entity @s[tag=TutorialWeapon,tag=Crossbow] as @p[tag=clicker] at @s run function tutorial:weapons/crossbow
execute if entity @s[tag=TutorialWeapon,tag=Harpoon] as @p[tag=clicker] at @s run function tutorial:weapons/harpoon
