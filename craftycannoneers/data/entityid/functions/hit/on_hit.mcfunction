...
execute if score $arrow CmdData matches 1 if entity @s[type=camel,tag=BoatCannonAnchor] on vehicle if entity @s[type=husk] on vehicle on passengers at @s[type=player] run function entityid:hit/fakearrow
execute if score $arrow CmdData matches 1 if entity @s[type=husk,tag=BoatCannonAnchor] on vehicle on passengers at @s[type=player] run function entityid:hit/fakearrow
