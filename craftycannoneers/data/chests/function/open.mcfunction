#Common
execute at @s[tag=CChestHopper] on vehicle run item replace entity @s armor.head with minecraft:diamond_hoe[custom_model_data={floats:[20.0f]}]
execute at @s[tag=CChestHopper] run playsound block.chest.open master @a ~ ~ ~ 0.8 1.3

#Uncommon
execute at @s[tag=UCChestHopper] on vehicle run item replace entity @s armor.head with minecraft:diamond_hoe[custom_model_data={floats:[24.0f]}]
execute at @s[tag=UCChestHopper] run playsound block.chest.open master @a ~ ~ ~ 0.8 1.1

#Rare
execute at @s[tag=RChestHopper] on vehicle run item replace entity @s armor.head with minecraft:diamond_hoe[custom_model_data={floats:[27.0f]}]
execute at @s[tag=RChestHopper] run playsound block.chest.open master @a ~ ~ ~ 0.8 0.7

#Locked
execute at @s[tag=lockedchest] on vehicle run item replace entity @s armor.head with minecraft:diamond_hoe[custom_model_data={floats:[71.0f]}]
...
#Cargo
execute at @s[tag=CargoHopper] on vehicle run item replace entity @s container.0 with minecraft:diamond_hoe[custom_model_data={floats:[115.0f]}]
execute at @s[tag=CargoHopper] run playsound block.barrel.open master @a ~ ~ ~ 0.8 1.3

#Grave
execute at @s[tag=grave] on vehicle run item replace entity @s armor.head with minecraft:diamond_hoe[custom_model_data={floats:[135.0f]}]
