summon chest_minecart ~ ~ ~ {LootTable:"chests:empty",Silent:1b,Invulnerable:1b,Rotation:[-90.0f, 0.0f],Tags:["chest","lockedchest","new"],CustomName:[{translate:"space.-48"},{text:"\uE02D",color:"white"},{translate:"space.-4096"}],DisplayState:{Name:"minecraft:crimson_wall_sign"}}
