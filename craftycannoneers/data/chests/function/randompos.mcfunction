...
execute at @s if entity @s[tag=!Nope,tag=Common] unless entity @e[type=armor_stand,tag=chest,distance=..8] run summon armor_stand ~ ~-1 ~ {Small:1b,Silent:1b,Marker:1b,Invisible:1b,Tags:["chest","CChestAS","NewChest"],ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",count:1,components:{custom_model_data:{floats:[19.0f]}}}],Passengers:[{id:"hopper_minecart",LootTable:"chests:empty",CustomDisplayTile:1b,DisplayState:{Name:"minecraft:air"},Invulnerable:1b,Silent:1b,Enabled:0b,CustomName:'[{"translate":"space.-8"},{"text":"\\uE028","color":"#7b7b00"},{"translate":"space.-169"},{"translate":"chest.common","color":"#a9a500","bold":true,"underlined":true},{"translate":"space.-4096"}]',Tags:["CChestHopper","chest"]}]}
execute at @s if entity @s[tag=!Nope,tag=Uncommon] unless entity @e[type=armor_stand,tag=chest,distance=..8] run summon armor_stand ~ ~-1 ~ {Small:1b,Silent:1b,Marker:1b,Invisible:1b,Tags:["chest","UCChestAS","NewChest"],ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",count:1,components:{custom_model_data:{floats:[23.0f]}}}],Passengers:[{id:"hopper_minecart",LootTable:"chests:empty",CustomDisplayTile:1b,DisplayState:{Name:"minecraft:air"},Invulnerable:1b,Silent:1b,Enabled:0b,CustomName:'[{"translate":"space.-8"},{"text":"\\uE029","color":"#7b7b00"},{"translate":"space.-169"},{"translate":"chest.uncommon","color":"#a9a600","bold":true,"underlined":true},{"translate":"space.-4096"}]',Tags:["UCChestHopper","chest"]}]}
execute at @s if entity @s[tag=!Nope,tag=Rare] unless entity @e[type=armor_stand,tag=chest,distance=..8] run summon armor_stand ~ ~-1 ~ {Small:1b,Silent:1b,Marker:1b,Invisible:1b,Tags:["chest","RChestAS","NewChest"],ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",count:1,components:{custom_model_data:{floats:[26.0f]}}}],Passengers:[{id:"hopper_minecart",LootTable:"chests:empty",CustomDisplayTile:1b,DisplayState:{Name:"minecraft:air"},Invulnerable:1b,Silent:1b,Enabled:0b,CustomName:'[{"translate":"space.-8"},{"text":"\\uE02A","color":"#7b7b00"},{"translate":"space.-169"},{"translate":"chest.rare","color":"#a9a700","bold":true,"underlined":true},{"translate":"space.-4096"}]',Tags:["RChestHopper","chest"]}]}
