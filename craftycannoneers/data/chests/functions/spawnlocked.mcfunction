...
execute as @e[type=marker,tag=SelectedLock,limit=1] at @s as @e[type=item_display,tag=BlastBarrel,distance=..1] at @s run function weapons:barrel/break
execute as @e[type=marker,tag=SelectedLock,limit=1] at @s as @e[type=item_display,tag=CrabTrap,distance=..1] at @s run function weapons:crabtrap/break
