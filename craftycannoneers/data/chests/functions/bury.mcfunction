...
execute at @s[scores={CmdData=171..200}] run particle block{block_state:"sand"} ~ ~ ~ 0 0 0 0.1 5 normal @a[team=!Lobby]
execute at @s[scores={CmdData=171..200}] run particle block{block_state:"dirt"} ~ ~ ~ 0 0 0 0.1 5 normal @a[team=!Lobby]
