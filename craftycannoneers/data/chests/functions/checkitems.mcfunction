...
execute unless entity @s[nbt={Inventory:[{id:"minecraft:diamond_hoe",tag:{Cannonball:8b}}]}] unless score $NoTracers CmdData matches 1 run loot give @s loot cannons:tracer