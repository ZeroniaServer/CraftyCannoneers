...
execute at @s[tag=LChestAS,scores={CmdData=30}] run summon villager ~ ~-1 ~ {Tags:["LChestVillager","notifylock"],Invulnerable:1b,NoGravity:1b,NoAI:1b,Silent:1b,Passengers:[{id:"minecraft:marker",Tags:["villager","lchest"],data:{Tags:["LChestVillager","notifylock"]}}]}
