...
execute at @s if entity @s[tag=!Nope,tag=!SpawnNew] if entity @e[type=armor_stand,tag=chest,distance=..8] run function chests:spawnnew
execute at @s if entity @s[tag=!Nope,tag=!SpawnNew] unless entity @e[type=armor_stand,tag=chest,distance=..8] as @e[type=item_display,tag=BlastBarrel,distance=..1] at @s run function weapons:barrel/break
execute at @s if entity @s[tag=!Nope,tag=!SpawnNew] unless entity @e[type=armor_stand,tag=chest,distance=..8] as @e[type=item_display,tag=CrabTrap,distance=..1] at @s run function weapons:crabtrap/break
execute at @s if entity @s[tag=!Nope,tag=!SpawnNew,tag=Common] unless entity @e[type=armor_stand,tag=chest,distance=..8] run summon armor_stand ~ ~-1 ~ {Small:1b,Silent:1b,Marker:1b,Invisible:1b,Tags:["chest","CChestAS","NewChest"],ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",Count:1b,tag:{CustomModelData:19}}],Passengers:[{id:"hopper_minecart",LootTable:"chests:empty",CustomDisplayTile:1b,DisplayState:{Name:"minecraft:air"},Invulnerable:1b,Silent:1b,Enabled:0b,CustomName:'{"translate":"chest.common","color":"dark_gray","bold":true,"underlined":true}',Tags:["CChestHopper","chest"]}]}
execute at @s if entity @s[tag=!Nope,tag=!SpawnNew,tag=Uncommon] unless entity @e[type=armor_stand,tag=chest,distance=..8] run summon armor_stand ~ ~-1 ~ {Small:1b,Silent:1b,Marker:1b,Invisible:1b,Tags:["chest","UCChestAS","NewChest"],ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",Count:1b,tag:{CustomModelData:23}}],Passengers:[{id:"hopper_minecart",LootTable:"chests:empty",CustomDisplayTile:1b,DisplayState:{Name:"minecraft:air"},Invulnerable:1b,Silent:1b,Enabled:0b,CustomName:'{"translate":"chest.uncommon","color":"dark_aqua","bold":true,"underlined":true}',Tags:["UCChestHopper","chest"]}]}
execute at @s if entity @s[tag=!Nope,tag=!SpawnNew,tag=Rare] unless entity @e[type=armor_stand,tag=chest,distance=..8] run summon armor_stand ~ ~-1 ~ {Small:1b,Silent:1b,Marker:1b,Invisible:1b,Tags:["chest","RChestAS","NewChest"],ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",Count:1b,tag:{CustomModelData:26}}],Passengers:[{id:"hopper_minecart",LootTable:"chests:empty",CustomDisplayTile:1b,DisplayState:{Name:"minecraft:air"},Invulnerable:1b,Silent:1b,Enabled:0b,CustomName:'{"translate":"chest.rare","color":"dark_purple","bold":true,"underlined":true}',Tags:["RChestHopper","chest"]}]}
execute as @e[type=armor_stand,tag=NewChest,tag=!Rotated] at @s run function chests:randomrotation
execute at @s if entity @s[tag=!Nope,tag=!SpawnNew] if entity @e[type=armor_stand,tag=chest,distance=..8] run kill @s
execute at @s if entity @s[tag=!Nope,tag=!SpawnNew] if entity @e[type=armor_stand,tag=chest,distance=..8] run tag @s add SpawnNew