...
execute as @a[team=Lobby,tag=HoldKey,scores={eyeclick=1..}] at @s if entity @e[type=armor_stand,tag=LChestFakeC,tag=!Unlocked,distance=..3] run scoreboard players add @s openchest 1
...
item modify entity @a[team=!Lobby,predicate=chests:key,scores={openchest=20..}] weapon.mainhand game:reducecount
item modify entity @a[team=!Lobby,predicate=chests:key_offhand,scores={openchest=20..}] weapon.offhand game:reducecount
...
execute as @a[team=Orange,scores={openchest=20}] at @s if entity @e[type=armor_stand,tag=purplechestdisplay,distance=..3] run advancement grant @s only tutorial:zzzunlockables/robbery
execute as @a[team=Purple,scores={openchest=20}] at @s if entity @e[type=armor_stand,tag=orangechestdisplay,distance=..3] run advancement grant @s only tutorial:zzzunlockables/robbery
...
execute as @a[team=Lobby,scores={openchest=20..}] at @s run tag @e[type=armor_stand,tag=LChestFakeC,tag=!Unlocked,limit=1,sort=nearest] add Unlocked
execute as @a[team=Lobby,scores={openchest=20..}] at @s run tag @e[type=armor_stand,tag=LChestFakeC,tag=!Unlocked,limit=1,sort=nearest] add Unlocked


scoreboard players reset @a[scores={openchest=20..}] openchest

execute as @a[team=!Lobby,scores={openchest=1..}] at @s unless entity @e[type=armor_stand,tag=LChestAS,tag=!Spawned,distance=..3] unless entity @e[type=armor_stand,tag=chestdisplay,tag=!Unlocked,distance=..3] run title @s title {"text":" ","color":"dark_aqua"}
execute as @a[team=!Lobby,scores={openchest=1..}] at @s unless entity @e[type=armor_stand,tag=LChestAS,tag=!Spawned,distance=..3] unless entity @e[type=armor_stand,tag=chestdisplay,tag=!Unlocked,distance=..3] run title @s subtitle {"text":" ","color":"dark_aqua"}
execute as @a[team=!Lobby,scores={openchest=1..}] at @s unless entity @e[type=armor_stand,tag=LChestAS,tag=!Spawned,distance=..3] unless entity @e[type=armor_stand,tag=chestdisplay,tag=!Unlocked,distance=..3] run scoreboard players reset @s openchest

execute as @a[team=Lobby,scores={openchest=1..}] at @s unless entity @e[type=armor_stand,tag=LChestFakeC,tag=!Spawned,distance=..3] unless entity @e[type=armor_stand,tag=fakechestdisplay,tag=!Unlocked,distance=..3] run title @s title {"text":" ","color":"dark_aqua"}
execute as @a[team=Lobby,scores={openchest=1..}] at @s unless entity @e[type=armor_stand,tag=LChestFakeC,tag=!Spawned,distance=..3] unless entity @e[type=armor_stand,tag=fakechestdisplay,tag=!Unlocked,distance=..3] run title @s subtitle {"text":" ","color":"dark_aqua"}
execute as @a[team=Lobby,scores={openchest=1..}] at @s unless entity @e[type=armor_stand,tag=LChestFakeC,tag=!Spawned,distance=..3] unless entity @e[type=armor_stand,tag=fakechestdisplay,tag=!Unlocked,distance=..3] run scoreboard players reset @s openchest
